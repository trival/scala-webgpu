...
function $p_Lexample_Main$__setStatus$5__Lorg_scalajs_dom_HTMLElement__T__Z__V(
	$thiz,
	statusEl$1,
	msg,
	isError,
...
function $p_Lexample_Main$__render$1__Lexample_GPUDevice__Lexample_GPUCanvasContext__Lexample_GPURenderPipeline__V(
	$thiz,
	device$1,
	context$1,
	pipeline$1,
...
$p.h0 = function (args) {
	...
	matchResult1: {
		...
		if ($m_s_None$() === x1) {
			$p_Lexample_Main$__setStatus$5__Lorg_scalajs_dom_HTMLElement__T__Z__V(
				this,
				statusEl,
		...
		if (x1 instanceof $c_s_Some) {
			...
			$p_Lexample_Main$__setStatus$5__Lorg_scalajs_dom_HTMLElement__T__Z__V(
				this,
				statusEl,
				"WebGPU available, initializing...",
				false,
			);
			this.gU(
				gpu,
				canvas,
				new $c_sr_AbstractFunction2_$$Lambda$286cbfc6187197affcadc8465aaec93d6b7d20dc(
					(v1$2, v2$2) => {
						$p_Lexample_Main$__setStatus$5__Lorg_scalajs_dom_HTMLElement__T__Z__V(
							this,
							statusEl,
...
$p.gU = function (gpu, canvas, setStatus) {
	var result = $m_sjs_js_Thenable$Implicits$()
		.fS(gpu.requestAdapter())
		.gE(
			new $c_sr_AbstractFunction1_$$Lambda$70e1780b84463d18653aacefee3ab989ac625f28(
				(adapter$2) =>
					$m_sjs_js_Thenable$Implicits$()
						.fS(adapter$2.requestDevice())
						.h1(
							new $c_sr_AbstractFunction1_$$Lambda$70e1780b84463d18653aacefee3ab989ac625f28(
								(device$2) => new $c_T2(adapter$2, device$2),
							),
...
$p.hf = function (device, canvas, setStatus) {
	...
	var wgslCode = $p_Lgpu_ShaderDef__buildWGSL__T__T__T__T__T__T__T(
		triangleShader,
		$p_Lgpu_derive$__generateCombinedStructFromLists__T__sci_List__sci_List__sci_List__T(
			$m_Lgpu_derive$(),
			"VertexInput",
			$m_sci_Nil$(),
			$m_sci_Nil$(),
			new $c_sci_$colon$colon(
				new $c_T3("vertexIndex", "vertex_index", "u32"),
				$m_sci_Nil$(),
			),
		),
		$p_Lgpu_derive$__generateCombinedStructFromLists__T__sci_List__sci_List__sci_List__T(
			$m_Lgpu_derive$(),
			"VertexOutput",
			new $c_sci_$colon$colon("color", $m_sci_Nil$()),
			new $c_sci_$colon$colon("vec4<f32>", $m_sci_Nil$()),
			new $c_sci_$colon$colon(
				new $c_T3("position", "position", "vec4<f32>"),
				$m_sci_Nil$(),
			),
		),
		$p_Lgpu_derive$__generateCombinedStructFromLists__T__sci_List__sci_List__sci_List__T(
	...
	$p_Lexample_Main$__render$1__Lexample_GPUDevice__Lexample_GPUCanvasContext__Lexample_GPURenderPipeline__V(
		this,
		device,
		context,
		$x_1,
...
var $d_Lexample_WebGPUHelpers$ = new $TypeData().i(
	$c_Lexample_WebGPUHelpers$,
	"example.WebGPUHelpers$",
	{
		ba: 1,
	},
);
...
function $p_Lgpu_derive$__generateCombinedStructFromLists__T__sci_List__sci_List__sci_List__T(
	$thiz,
	structName,
	locNames,
	locTypes,
	...
	var this$2 = $f_sc_StrictOptimizedIterableOps__zipWithIndex__O(
	...
	var allFields = locationFields.gc(builtinFields);
	return allFields.n()
		? ""
		: "struct " +
				structName +
...
function $p_jl_StackTrace$__normalizedLinesToStackTrace__O__Ajl_StackTraceElement(
	$thiz,
	lines,
) {
	var NormalizedFrameLine = $m_jl_StackTrace$StringRE$().br(
		"^([^@]*)@(.*?):([0-9]+)(?::([0-9]+))?$",
	);
	var trace = [];
	var i = 0;
	while (i < (lines.length | 0)) {
		...
		if (line !== "") {
			...
			if (mtch !== null) {
				var classAndMethodName = $p_jl_StackTrace$__extractClassMethod__T__O(
					$thiz,
					mtch[1],
				);
				...
				var x$3 = mtch[4];
				var $x_1 = trace.push(
					new $c_jl_StackTraceElement(
						$x_5,
						$x_4,
						$x_3,
						$x_2 | 0,
						x$3 !== void 0 ? parseInt(x$3) | 0 : -1,
					),
				);
			} else {
				trace.push(
					new $c_jl_StackTraceElement("<jscode>", line, null, -1, -1),
				) | 0;
			}
		}
		i = (1 + i) | 0;
...
function $p_jl_StackTrace$__extractClassMethod__T__O($thiz, functionName) {
	var PatBC = $m_jl_StackTrace$StringRE$().br(
		"^(?:Object\\.|\\[object Object\\]\\.|Module\\.)?\\$[bc]_([^\\.]+)(?:\\.prototype)?\\.([^\\.]+)$",
	);
	var PatS = $m_jl_StackTrace$StringRE$().br(
		"^(?:Object\\.|\\[object Object\\]\\.|Module\\.)?\\$(?:ps?|s|f)_((?:_[^_]|[^_])+)__([^\\.]+)$",
	);
	var PatCT = $m_jl_StackTrace$StringRE$().br(
		"^(?:Object\\.|\\[object Object\\]\\.|Module\\.)?\\$ct_((?:_[^_]|[^_])+)__([^\\.]*)$",
	);
	var PatN = $m_jl_StackTrace$StringRE$().br(
		"^new (?:Object\\.|\\[object Object\\]\\.|Module\\.)?\\$c_([^\\.]+)$",
	);
	var PatM = $m_jl_StackTrace$StringRE$().br(
	...
	if (matchBCOrS !== null) {
		return [
			$p_jl_StackTrace$__decodeClassName__T__T($thiz, matchBCOrS[1]),
			$p_jl_StackTrace$__decodeMethodName__T__T($thiz, matchBCOrS[2]),
		];
	} else {
		...
		if (matchCTOrN !== null) {
			return [
				$p_jl_StackTrace$__decodeClassName__T__T($thiz, matchCTOrN[1]),
				"<init>",
			];
		} else {
			...
			return matchM !== null
				? [
						$p_jl_StackTrace$__decodeClassName__T__T($thiz, matchM[1]),
						"<clinit>",
					]
				: ["<jscode>", functionName];
		}
...
function $p_jl_StackTrace$__decompressedClasses__O($thiz) {
	return ((1 & $thiz.b5) << 24) >> 24 === 0
		? $p_jl_StackTrace$__decompressedClasses$lzycompute__O($thiz)
		: $thiz.e0;
}
...
function $p_jl_StackTrace$__decompressedPrefixes__O($thiz) {
	return ((2 & $thiz.b5) << 24) >> 24 === 0
		? $p_jl_StackTrace$__decompressedPrefixes$lzycompute__O($thiz)
		: $thiz.e1;
}
...
function $p_jl_StackTrace$__compressedPrefixes__O($thiz) {
	return ((4 & $thiz.b5) << 24) >> 24 === 0
		? $p_jl_StackTrace$__compressedPrefixes$lzycompute__O($thiz)
		: $thiz.dZ;
}
...
function $p_jl_StackTrace$__normalizeStackTraceLines__O__O($thiz, e) {
	return !!!!!e
		? []
		: !!!!(e.arguments && e.stack)
			? $p_jl_StackTrace$__extractChrome__O__O($thiz, e)
			: !!!!(e.stack && e.sourceURL)
				? $p_jl_StackTrace$__extractSafari__O__O($thiz, e)
				: !!!!(e.stack && e.number)
					? $p_jl_StackTrace$__extractIE__O__O($thiz, e)
					: !!!!(e.stack && e.fileName)
						? $p_jl_StackTrace$__extractFirefox__O__O($thiz, e)
						: !!!!(e.message && e["opera#sourceloc"])
							? !!!!!e.stacktrace
								? $p_jl_StackTrace$__extractOpera9__O__O($thiz, e)
								: !!!!(
											e.message.indexOf("\n") > -1.0 &&
											e.message.split("\n").length >
												e.stacktrace.split("\n").length
									...
									? $p_jl_StackTrace$__extractOpera9__O__O($thiz, e)
									: $p_jl_StackTrace$__extractOpera10a__O__O($thiz, e)
							: !!!!(e.message && e.stack && e.stacktrace)
								? !!!!(e.stacktrace.indexOf("called from line") < 0.0)
									? $p_jl_StackTrace$__extractOpera10b__O__O($thiz, e)
									: $p_jl_StackTrace$__extractOpera11__O__O($thiz, e)
								: !!!!(e.stack && !e.fileName)
									? $p_jl_StackTrace$__extractChrome__O__O($thiz, e)
									: $p_jl_StackTrace$__extractOther__O__O($thiz, e);
}
function $p_jl_StackTrace$__extractChrome__O__O($thiz, e) {
	return (e.stack + "\n")
		.replace($m_jl_StackTrace$StringRE$().br("^[\\s\\S]+?\\s+at\\s+"), " at ")
		.replace(
			$m_jl_StackTrace$StringRE$().aU("^\\s+(at eval )?at\\s+", "gm"),
			"",
		)
		.replace(
			$m_jl_StackTrace$StringRE$().aU("^([^\\(]+?)([\\n])", "gm"),
			"{anonymous}() ($1)$2",
		)
		.replace(
			$m_jl_StackTrace$StringRE$().aU(
...
function $p_jl_StackTrace$__extractFirefox__O__O($thiz, e) {
	return e.stack
		.replace($m_jl_StackTrace$StringRE$().aU("(?:\\n@:0)?\\s+$", "m"), "")
		.replace(
			$m_jl_StackTrace$StringRE$().aU("^(?:\\((\\S*)\\))?@", "gm"),
			"{anonymous}($1)@",
		)
		.split("\n");
}
function $p_jl_StackTrace$__extractIE__O__O($thiz, e) {
	var qual$1 = e.stack
		.replace($m_jl_StackTrace$StringRE$().aU("^\\s*at\\s+(.*)$", "gm"), "$1")
		.replace(
			$m_jl_StackTrace$StringRE$().aU("^Anonymous function\\s+", "gm"),
			"{anonymous}() ",
		)
		.replace(
			$m_jl_StackTrace$StringRE$().aU(
...
function $p_jl_StackTrace$__extractSafari__O__O($thiz, e) {
	return e.stack
		.replace($m_jl_StackTrace$StringRE$().aU("\\[native code\\]\\n", "m"), "")
		.replace(
			$m_jl_StackTrace$StringRE$().aU("^(?=\\w+Error\\:).*$\\n", "m"),
			"",
		)
		.replace($m_jl_StackTrace$StringRE$().aU("^@", "gm"), "{anonymous}()@")
		.split("\n");
}
function $p_jl_StackTrace$__extractOpera9__O__O($thiz, e) {
	var lineRE = $m_jl_StackTrace$StringRE$().aU(
		"Line (\\d+).*script (?:in )?(\\S+)",
		"i",
	);
...
function $p_jl_StackTrace$__extractOpera11__O__O($thiz, e) {
	var lineRE = $m_jl_StackTrace$StringRE$().br(
	...
	while (i < len) {
		...
		if (mtch !== null) {
			...
			var fnName = fnName0
				.replace(
					$m_jl_StackTrace$StringRE$().br("<anonymous function: (\\S+)>"),
					"$1",
				)
				.replace(
					$m_jl_StackTrace$StringRE$().br("<anonymous function>"),
					"{anonymous}",
				);
...
function $p_jl_StackTrace$__loop$1__I__T__T($thiz, i, encodedName$1) {
	while (true) {
		if (i < ($p_jl_StackTrace$__compressedPrefixes__O($thiz).length | 0)) {
			...
			return !!encodedName$1.startsWith("L")
				? encodedName$1.substring(1)
				: encodedName$1;
		}
	}
}
...
$p.gA = function (jsError) {
	return $p_jl_StackTrace$__normalizedLinesToStackTrace__O__Ajl_StackTraceElement(
		this,
		$p_jl_StackTrace$__normalizeStackTraceLines__O__O(this, jsError),
	);
};
var $d_jl_StackTrace$ = new $TypeData().i(
	$c_jl_StackTrace$,
...
$p.aU = function (this$, mods) {
	return new RegExp(this$, mods);
};
var $d_jl_StackTrace$StringRE$ = new $TypeData().i(
	$c_jl_StackTrace$StringRE$,
	"java.lang.StackTrace$StringRE$",
	{
		bA: 1,
	},
);
...
var $d_jl_ThreadLocal = new $TypeData().i(
	$c_jl_ThreadLocal,
...
function $s_RTLong__fromDouble__D__RTLong(value) {
	var this$1 = $m_RTLong$();
	return new $c_RTLong(this$1.fJ(value), this$1.s);
}
...
function $s_RTLong__mul__RTLong__RTLong__RTLong(a, b) {
	...
	return new $c_RTLong(
		lo,
		(((((((Math.imul(alo, b.g) + Math.imul(a.g, blo)) | 0) +
			Math.imul(a1, b1)) |
			0) +
			((c1part >>> 16) | 0)) |
			0) +
...
function $s_RTLong__sub__RTLong__RTLong__RTLong(a, b) {
	...
	return new $c_RTLong(
		lo,
		(((a.g - b.g) | 0) + (((~alo & blo) | (~(alo ^ blo) & lo)) >> 31)) | 0,
	);
}
...
function $s_RTLong__sar__RTLong__I__RTLong(a, n) {
	var hi = a.g;
	return new $c_RTLong(
		(32 & n) === 0 ? (a.f >>> n) | 0 | ((hi << 1) << ((31 - n) | 0)) : hi >> n,
		(32 & n) === 0 ? hi >> n : hi >> 31,
	);
}
...
$p.A = function () {
	return $m_RTLong$().fK(this.f, this.g);
};
$p.hr = function () {
	return (this.f << 24) >> 24;
};
...
$p.ht = function (that) {
	return $m_RTLong$().fI(this.f, this.g, that.f, that.g);
};
$p.hs = function (that) {
	return $m_RTLong$().fI(this.f, this.g, that.f, that.g);
};
...
function $p_s_Array$__slowcopy__O__I__O__I__I__V(
	...
	while (i < srcUntil) {
		$m_sr_ScalaRunTime$().fw(dest, j, $m_sr_ScalaRunTime$().gi(src, i));
		i = (1 + i) | 0;
		j = (1 + j) | 0;
	}
}
...
var $d_s_Array$EmptyArrays$ = new $TypeData().i(
...
var $d_sc_Hashing$ = new $TypeData().i(
	$c_sc_Hashing$,
...
function $f_sc_IterableOnceOps__copyToArray__O__I__I__I($thiz, dest, start, n) {
	...
	while (i < end && it.k()) {
		$m_sr_ScalaRunTime$().fw(dest, i, it.h());
		i = (1 + i) | 0;
	}
	return (i - start) | 0;
}
...
function $c_sci_IndexedSeqDefaults$() {
	...
	try {
		$m_sc_StringOps$();
		var $x_1 = $m_jl_Integer$().fG(
			$m_jl_System$SystemProperties$().ew(
...
function $c_sci_MapNode$() {
	...
	this.f1 = new $c_sci_BitmapIndexedMapNode(
		0,
		0,
		new $ac_O(0),
		new $ac_I(0),
...
var $d_sci_MapNode$ = new $TypeData().i(
	$c_sci_MapNode$,
...
function $p_sci_Node__arrayIndexOutOfBounds__O__I__jl_ArrayIndexOutOfBoundsException(
	$thiz,
	as,
	ix,
) {
	return $ct_jl_ArrayIndexOutOfBoundsException__T__(
		new $c_jl_ArrayIndexOutOfBoundsException(),
		ix +
			" is out of bounds (min 0, max " +
			((-1 + $m_jl_reflect_Array$().dS(as)) | 0),
	);
}
/** @constructor */
function $c_sci_Node() {}
...
$p.fM = function (as, ix) {
	if (ix < 0) {
		throw $p_sci_Node__arrayIndexOutOfBounds__O__I__jl_ArrayIndexOutOfBoundsException(
			this,
			as,
			ix,
		);
...
var $d_sci_VectorStatics$ = new $TypeData().i(
	$c_sci_VectorStatics$,
...
function $ct_s_concurrent_BatchingExecutor$AbstractBatch__jl_Runnable__Ajl_Runnable__I__(
	$thiz,
	first,
	other,
	size,
...
function $p_s_concurrent_BatchingExecutor$AbstractBatch__ensureCapacity__I__Ajl_Runnable(
	$thiz,
	curSize,
) {
...
$p.hb = function (r) {
	...
	if (sz === 0) {
		...
		$p_s_concurrent_BatchingExecutor$AbstractBatch__ensureCapacity__I__Ajl_Runnable(
			this,
			sz,
		).a[(-1 + sz) | 0] = r;
	}
...
var $d_s_concurrent_BatchingExecutorStatics$ = new $TypeData().i(
	$c_s_concurrent_BatchingExecutorStatics$,
...
function $m_s_concurrent_BatchingExecutorStatics$() {
	if (!$n_s_concurrent_BatchingExecutorStatics$) {
		$n_s_concurrent_BatchingExecutorStatics$ =
			new $c_s_concurrent_BatchingExecutorStatics$();
	}
...
var $d_s_concurrent_ExecutionContext$ = new $TypeData().i(
...
function $c_s_concurrent_Future$() {
	...
	$m_sci_Map$().gF(
		new $c_sjsr_WrappedVarArgs([
			new $c_T2($d_Z.l(), $d_jl_Boolean.l()),
			new $c_T2($d_B.l(), $d_jl_Byte.l()),
			new $c_T2($d_C.l(), $d_jl_Character.l()),
			new $c_T2($d_S.l(), $d_jl_Short.l()),
			new $c_T2($d_I.l(), $d_jl_Integer.l()),
			new $c_T2($d_J.l(), $d_jl_Long.l()),
			new $c_T2($d_F.l(), $d_jl_Float.l()),
			new $c_T2($d_D.l(), $d_jl_Double.l()),
			new $c_T2($d_V.l(), $d_jl_Void.l()),
		]),
	);
	this.fe =
		new $c_sr_AbstractFunction1_$$Lambda$70e1780b84463d18653aacefee3ab989ac625f28(
	...
	this.ff = $m_s_concurrent_Future$().fD(this.eg);
	this.fd =
		new $c_sr_AbstractFunction1_$$Lambda$70e1780b84463d18653aacefee3ab989ac625f28(
			(v$2) =>
				v$2 instanceof $c_s_util_Failure
					? new $c_s_util_Success(v$2.bK)
					: this.eg,
		);
	...
	this.fD(new $c_s_util_Success(void 0));
}
...
$p.fD = function (result) {
	return $ct_s_concurrent_impl_Promise$DefaultPromise__s_util_Try__(
		new $c_s_concurrent_impl_Promise$DefaultPromise(),
		result,
	);
};
var $d_s_concurrent_Future$ = new $TypeData().i(
...
function $f_s_concurrent_Promise__complete__s_util_Try__s_concurrent_Promise(
	$thiz,
	result,
) {
	if ($thiz.hm(result)) {
...
function $f_s_concurrent_Promise__success__O__s_concurrent_Promise(
	$thiz,
	value,
) {
	return $f_s_concurrent_Promise__complete__s_util_Try__s_concurrent_Promise(
		$thiz,
		new $c_s_util_Success(value),
	);
}
function $f_s_concurrent_Promise__failure__jl_Throwable__s_concurrent_Promise(
	$thiz,
	cause,
) {
	return $f_s_concurrent_Promise__complete__s_util_Try__s_concurrent_Promise(
		$thiz,
		new $c_s_util_Failure(cause),
	);
}
/** @constructor */
...
$p.gC = function (exception) {
	return $ct_s_concurrent_impl_Promise$DefaultPromise__s_util_Try__(
		new $c_s_concurrent_impl_Promise$DefaultPromise(),
		new $c_s_util_Failure(exception),
	);
};
var $d_s_concurrent_Promise$ = new $TypeData().i(
	$c_s_concurrent_Promise$,
...
function $c_s_concurrent_impl_Promise$() {
	...
	this.de =
		$ct_s_concurrent_impl_Promise$Transformation__I__F1__s_concurrent_ExecutionContext__(
			new $c_s_concurrent_impl_Promise$Transformation(),
			0,
			null,
			$m_s_concurrent_ExecutionContext$parasitic$(),
		);
}
...
$p.dt = function (value) {
	...
	if (value instanceof $c_s_util_Success) {
		...
		var t = value.bK;
		return false || false || t instanceof $c_jl_Error
			? false
				? new $c_s_util_Success(t.fY())
				: new $c_s_util_Failure(
						new $c_ju_concurrent_ExecutionException("Boxed Exception", t),
					)
			: value;
	}
};
var $d_s_concurrent_impl_Promise$ = new $TypeData().i(
...
var $d_sr_Statics$PFMarker$ = new $TypeData().i(
	$c_sr_Statics$PFMarker$,
...
var $d_sjs_concurrent_JSExecutionContext$ = new $TypeData().i(
	$c_sjs_concurrent_JSExecutionContext$,
...
function $m_sjs_concurrent_JSExecutionContext$() {
	if (!$n_sjs_concurrent_JSExecutionContext$) {
		$n_sjs_concurrent_JSExecutionContext$ =
			new $c_sjs_concurrent_JSExecutionContext$();
	}
...
$p.gh = function () {
	return typeof Promise === "undefined"
		? new $c_sjs_concurrent_QueueExecutionContext$TimeoutsExecutionContext()
		: new $c_sjs_concurrent_QueueExecutionContext$PromisesExecutionContext();
};
var $d_sjs_concurrent_QueueExecutionContext$ = new $TypeData().i(
...
function $m_sjs_concurrent_QueueExecutionContext$() {
	if (!$n_sjs_concurrent_QueueExecutionContext$) {
		$n_sjs_concurrent_QueueExecutionContext$ =
			new $c_sjs_concurrent_QueueExecutionContext$();
	}
...
$p.fS = function (p) {
	return $m_sjs_js_Thenable$ThenableOps$().hk(p);
};
var $d_sjs_js_Thenable$Implicits$ = new $TypeData().i(
	$c_sjs_js_Thenable$Implicits$,
...
$p.hk = function (this$) {
	var p2 = $ct_s_concurrent_impl_Promise$DefaultPromise__(
		new $c_s_concurrent_impl_Promise$DefaultPromise(),
	);
	this$.then(
		(arg1$2) => {
		...
		$m_sjs_js_defined$().gg((arg1$2$1) => {
			$f_s_concurrent_Promise__failure__jl_Throwable__s_concurrent_Promise(
				p2,
				arg1$2$1 instanceof $c_jl_Throwable
					? arg1$2$1
					: new $c_sjs_js_JavaScriptException(arg1$2$1),
			);
		}),
	);
	return p2;
};
var $d_sjs_js_Thenable$ThenableOps$ = new $TypeData().i(
	$c_sjs_js_Thenable$ThenableOps$,
...
var $d_sjs_js_defined$ = new $TypeData().i(
	$c_sjs_js_defined$,
	"scala.scalajs.js.defined$",
	{
		e0: 1,
	},
);
...
function $f_s_util_control_NoStackTrace__fillInStackTrace__jl_Throwable($thiz) {
	return $m_s_util_control_NoStackTrace$().fp
		? $c_jl_Throwable.prototype.cP.call($thiz)
		: $thiz;
}
/** @constructor */
...
var $d_s_util_control_NoStackTrace$ = new $TypeData().i(
	$c_s_util_control_NoStackTrace$,
...
var $d_s_util_control_NonFatal$ = new $TypeData().i(
...
$p.gY = function (xs, seed) {
	...
	return rangeState === 2
		? this.hc(initial, rangeDiff, prev, seed)
		: this.aH(h, n);
};
...
$p.fG = function (s, radix, overflowBarrier) {
	if (s === null) {
		$m_jl_Integer$().dr(s);
	}
	var len = s.length;
...
$p.H = function (that) {
	return (
		that instanceof $c_jl_StackTraceElement &&
		this.cB === that.cB &&
		this.cC === that.cC &&
		this.cz === that.cz &&
		this.cA === that.cA &&
...
$p.I = function () {
	return (
		$f_T__hashCode__I(this.cA) ^
		$f_T__hashCode__I(this.cY) ^
		$f_T__hashCode__I(this.cB) ^
		this.cC ^
		this.cz
	);
};
function $isArrayOf_jl_StackTraceElement(obj, depth) {
	return !!(
		...
		obj.$classData &&
		obj.$classData.D === depth &&
		obj.$classData.B.n.ax
	);
}
var $d_jl_StackTraceElement = new $TypeData().i(
...
class $c_jl_Throwable extends Error {
	...
	cP() {
		var reference =
			this instanceof $c_sjs_js_JavaScriptException ? this.bp : this;
		this.eJ =
			Object.prototype.toString.call(reference) === "[object Error]"
				? reference
				: Error.captureStackTrace === void 0 || !!Object.isSealed(this)
					? new Error()
			...
			if (thisLength !== 0) {
				...
				while (true) {
					if (sameFrameCount < thisLength && sameFrameCount < parentLength) {
						...
						var x$2 =
							parentTrace.a[(-1 + ((parentLength - sameFrameCount) | 0)) | 0];
...
function $f_s_concurrent_BatchingExecutor__submitSyncBatched__jl_Runnable__V(
	$thiz,
	runnable,
) {
	if (runnable === null) {
	...
	if (b instanceof $c_s_concurrent_BatchingExecutor$SyncBatch) {
		...
		if (i < 16) {
			...
			try {
				...
				var e$2 =
					e instanceof $c_jl_Throwable
						? e
						: new $c_sjs_js_JavaScriptException(e);
				if (false) {
			...
			var batch = new $c_s_concurrent_BatchingExecutor$SyncBatch(
				$thiz,
				runnable,
			);
			tl.du(batch);
...
function $isArrayOf_s_concurrent_impl_Promise$ManyCallbacks(obj, depth) {
	return !!(
		...
		obj.$classData &&
		obj.$classData.D === depth &&
		obj.$classData.B.n.b4
	);
}
var $d_s_concurrent_impl_Promise$ManyCallbacks = new $TypeData().i(
	$c_s_concurrent_impl_Promise$ManyCallbacks,
	"scala.concurrent.impl.Promise$ManyCallbacks",
	{
		b4: 1,
		a3: 1,
	},
...
function $c_s_util_hashing_MurmurHash3$() {
	...
	this.g1 = $f_T__hashCode__I("Set");
	this.el = this.fV($m_sci_Nil$(), this.c3);
}
...
$h_s_util_hashing_MurmurHash3$.prototype = $p;
$p.bs = function (x, y) {
	return this.fU($m_sr_Statics$().ac(x), $m_sr_Statics$().ac(y), -889275714);
};
$p.fQ = function (xs) {
...
var $d_s_util_hashing_MurmurHash3$accum$1 = new $TypeData().i(
	$c_s_util_hashing_MurmurHash3$accum$1,
	"scala.util.hashing.MurmurHash3$accum$1",
	{
		e8: 1,
		aA: 1,
	},
...
function $ct_sc_IterableFactory$Delegate__sc_IterableFactory__(
	$thiz,
	delegate,
) {
	$thiz.e6 = delegate;
	...
	if ((this.F & bitpos) !== 0) {
		...
		if ($m_sr_BoxesRunTime$().i(key, this.c8(index))) {
			...
			throw $ct_ju_NoSuchElementException__T__(
				new $c_ju_NoSuchElementException(),
				"key not found: " + key,
			);
		}
	} else if ((this.Q & bitpos) !== 0) {
		return this.bL($m_sci_Node$().by(this.Q, mask, bitpos)).em(
			key,
			originalHash,
			keyHash,
			(5 + shift) | 0,
...
$p.ev = function (key, originalHash, keyHash, shift, f) {
	...
	if ((this.F & bitpos) !== 0) {
		var index = $m_sci_Node$().by(this.F, mask, bitpos);
		return $m_sr_BoxesRunTime$().i(key, this.c8(index))
			? this.bM(index)
			: f.aT();
	} else {
		return (this.Q & bitpos) !== 0
			? this.bL($m_sci_Node$().by(this.Q, mask, bitpos)).ev(
					key,
					originalHash,
					keyHash,
					(5 + shift) | 0,
...
$p.er = function (key, originalHash, keyHash, shift) {
	...
	if ((this.F & bitpos) !== 0) {
		var index = $m_sci_Node$().by(this.F, mask, bitpos);
		return (
			this.aK.a[index] === originalHash &&
			$m_sr_BoxesRunTime$().i(key, this.c8(index))
		);
	} else {
		return (
			(this.Q & bitpos) !== 0 &&
			this.bL($m_sci_Node$().by(this.Q, mask, bitpos)).er(
				key,
				originalHash,
				keyHash,
				(5 + shift) | 0,
...
$p.fW = function (key, value, originalHash, keyHash, shift, replaceValue) {
	var mask = $m_sci_Node$().cq(keyHash, shift);
	var bitpos = $m_sci_Node$().c6(mask);
	if ((this.F & bitpos) !== 0) {
		var index = $m_sci_Node$().by(this.F, mask, bitpos);
		...
		if (
			key0UnimprovedHash === originalHash &&
			$m_sr_BoxesRunTime$().i(key0, key)
		) {
			if (replaceValue) {
				var value0 = this.bM(index);
				return Object.is(key0, key) && Object.is(value0, value)
					? this
					: this.gq(bitpos, key, value);
			} else {
				return this;
			}
		} else {
		...
		return subNodeNew$2 === subNode
			? this
			: this.gp(bitpos, subNode, subNodeNew$2);
	} else {
...
$p.eA = function (
	...
	if (shift >= 32) {
		return new $c_sci_HashCollisionMapNode(
			originalHash0,
			keyHash0,
			$m_sci_Vector$().fC(
				new $c_sjsr_WrappedVarArgs([
					new $c_T2(key0, value0),
					new $c_T2(key1, value1),
				]),
			),
		);
	} else {
		...
		if (mask0 !== mask1) {
			...
			if (mask0 < mask1) {
				...
				var iterator = new $c_sc_IndexedSeqView$IndexedSeqViewIterator(
					new $c_sc_IndexedSeqView$Id(xs),
				);
				var i = 0;
				while (iterator.aI > 0) {
				...
				return new $c_sci_BitmapIndexedMapNode(
					dataMap,
					0,
					array$2,
					new $ac_I(new Int32Array([originalHash0, originalHash1])),
					2,
					newCachedHash,
				);
			} else {
				...
				var iterator$1 = new $c_sc_IndexedSeqView$IndexedSeqViewIterator(
					new $c_sc_IndexedSeqView$Id(xs$1),
				);
				var i$1 = 0;
				...
				return new $c_sci_BitmapIndexedMapNode(
					...
					0,
					array$4,
					new $ac_I(new Int32Array([originalHash1, originalHash0])),
					2,
					newCachedHash,
				);
			}
			...
			var iterator$2 = new $c_sc_IndexedSeqView$IndexedSeqViewIterator(
				new $c_sc_IndexedSeqView$Id(xs$2),
			);
			var i$2 = 0;
...
$p.gp = function (bitpos, oldNode, newNode) {
	...
	return new $c_sci_BitmapIndexedMapNode(
		...
		dst,
		this.aK,
		(((this.ao - oldNode.az()) | 0) + newNode.az()) | 0,
		(((this.aC - oldNode.c7()) | 0) + newNode.c7()) | 0,
	);
};
...
$p.h3 = function (bitpos, keyHash, node) {
	...
	var dstHashes = this.fM(this.aK, dataIx);
...
$p.go = function (bitpos, keyHash, node) {
	...
	return new $c_sci_BitmapIndexedMapNode(
		...
		dst,
		dstHashes,
		(((-1 + this.ao) | 0) + node.az()) | 0,
		(((this.aC - keyHash) | 0) + node.c7()) | 0,
	);
};
$p.cn = function (f) {
...
$p.H = function (that) {
	if (that instanceof $c_sci_BitmapIndexedMapNode) {
		if (this === that) {
			...
			this.F === that.F &&
			this.ao === that.ao &&
			$m_ju_Arrays$().gw(this.aK, that.aK)
		) {
			var a1 = this.a0;
			var a2 = that.a0;
...
$p.fy = function () {
	...
	while (i$1 < contentLength) {
		contentClone.a[i$1] = contentClone.a[i$1].fz();
		i$1 = (1 + i$1) | 0;
	}
	return new $c_sci_BitmapIndexedMapNode(
		this.F,
...
$p.fX = function (key, value, originalHash, hash, shift, replaceValue) {
	return this.fW(key, value, originalHash, hash, shift, replaceValue);
};
$p.fz = function () {
	return this.fy();
};
...
var $d_sci_BitmapIndexedMapNode = new $TypeData().i(
...
$p.em = function (key, originalHash, hash, shift) {
	...
	return this$1.n() ? $m_sc_Iterator$().a2.h() : this$1.b2();
};
...
$p.fX = function (key, value, originalHash, hash, shift, replaceValue) {
	...
	return index >= 0
		? replaceValue
			? Object.is(this.R.C(index).ai, value)
				? this
				: new $c_sci_HashCollisionMapNode(
						originalHash,
						hash,
						this.R.ca(index, new $c_T2(key, value)),
					)
			: this
		: new $c_sci_HashCollisionMapNode(
				originalHash,
				hash,
				this.R.c4(new $c_T2(key, value)),
			);
};
$p.ey = function () {
	return false;
...
var $d_sci_HashCollisionMapNode = new $TypeData().i(
...
var $d_sci_HashMap$ = new $TypeData().i(
	$c_sci_HashMap$,
...
$p.gF = function (it) {
	...
	return new $c_sci_MapBuilderImpl().fs(it).fO();
};
var $d_sci_Map$ = new $TypeData().i(
	$c_sci_Map$,
...
function $c_s_concurrent_BatchingExecutor$SyncBatch(outer, runnable) {
	...
	this.g0 = outer;
	$ct_s_concurrent_BatchingExecutor$AbstractBatch__jl_Runnable__Ajl_Runnable__I__(
		this,
		runnable,
		$m_s_concurrent_BatchingExecutorStatics$().f9,
		1,
	);
}
$p = $c_s_concurrent_BatchingExecutor$SyncBatch.prototype =
	new $h_s_concurrent_BatchingExecutor$AbstractBatch();
...
$p.cu = function () {
	while (true) {
		try {
			...
			var e$2 =
				e instanceof $c_jl_Throwable ? e : new $c_sjs_js_JavaScriptException(e);
			if (false) {
				$m_s_concurrent_ExecutionContext$().cM.l(e$2);
			} else {
				matchResult2: {
...
function $isArrayOf_s_concurrent_BatchingExecutor$SyncBatch(obj, depth) {
	return !!(
		...
		obj.$classData &&
		obj.$classData.D === depth &&
		obj.$classData.B.n.b0
	);
}
var $d_s_concurrent_BatchingExecutor$SyncBatch = new $TypeData().i(
	$c_s_concurrent_BatchingExecutor$SyncBatch,
	"scala.concurrent.BatchingExecutor$SyncBatch",
	{
		b0: 1,
		di: 1,
		a6: 1,
...
$p = $c_s_concurrent_impl_Promise$Link.prototype =
	new $h_ju_concurrent_atomic_AtomicReference();
...
function $isArrayOf_s_concurrent_impl_Promise$Link(obj, depth) {
	return !!(
		...
		obj.$classData &&
		obj.$classData.D === depth &&
		obj.$classData.B.n.b3
	);
}
var $d_s_concurrent_impl_Promise$Link = new $TypeData().i(
	$c_s_concurrent_impl_Promise$Link,
	"scala.concurrent.impl.Promise$Link",
	{
		b3: 1,
		a8: 1,
		a: 1,
...
/** @constructor */
function $c_sr_AbstractFunction2_$$Lambda$286cbfc6187197affcadc8465aaec93d6b7d20dc(
	f,
) {
	this.fk = null;
	this.fk = f;
...
$p =
	$c_sr_AbstractFunction2_$$Lambda$286cbfc6187197affcadc8465aaec93d6b7d20dc.prototype =
		new $h_sr_AbstractFunction2();
$p.constructor =
	$c_sr_AbstractFunction2_$$Lambda$286cbfc6187197affcadc8465aaec93d6b7d20dc;
/** @constructor */
function $h_sr_AbstractFunction2_$$Lambda$286cbfc6187197affcadc8465aaec93d6b7d20dc() {}
$h_sr_AbstractFunction2_$$Lambda$286cbfc6187197affcadc8465aaec93d6b7d20dc.prototype =
	$p;
$p.ci = function (x0, x1) {
	return (0, this.fk)(x0, x1);
};
var $d_sr_AbstractFunction2_$$Lambda$286cbfc6187197affcadc8465aaec93d6b7d20dc =
	new $TypeData().i(
		$c_sr_AbstractFunction2_$$Lambda$286cbfc6187197affcadc8465aaec93d6b7d20dc,
		"scala.runtime.AbstractFunction2.$$Lambda$286cbfc6187197affcadc8465aaec93d6b7d20dc",
		{
			dH: 1,
			dG: 1,
			aA: 1,
...
function $isArrayOf_s_util_control_ControlThrowable(obj, depth) {
	return !!(
		...
		obj.$classData &&
		obj.$classData.D === depth &&
		obj.$classData.B.n.e3
	);
}
function $p_Lgpu_ShaderDef__buildWGSL__T__T__T__T__T__T__T(
	$thiz,
	vertexInputStruct,
	vertexOutputStruct,
	...
	var this$4 = new $c_sci_$colon$colon(
		vertexInputStruct,
		new $c_sci_$colon$colon(
			vertexOutputStruct,
			new $c_sci_$colon$colon(
				...
				new $c_sci_$colon$colon(
					uniformDecls,
					new $c_sci_$colon$colon(
						$p_Lgpu_ShaderDef__buildVertexMain__T__T($thiz, vertexBody),
						new $c_sci_$colon$colon(
							$p_Lgpu_ShaderDef__buildFragmentMain__T__T($thiz, fragmentBody),
							$m_sci_Nil$(),
						),
					),
				),
				...
				while (true) {
					if (remaining$tailLocal1.n()) {
						...
						while (toProcess !== firstMiss) {
							var newElem = new $c_sci_$colon$colon(
								toProcess.am(),
								$m_sci_Nil$(),
							);
						...
						while (!next.n()) {
							...
							if (!!f(head) !== false) {
								...
								while (nextToCopy !== next) {
									var newElem$2 = new $c_sci_$colon$colon(
										nextToCopy.am(),
										$m_sci_Nil$(),
									);
...
$p.H = function (x$0) {
	return (
		this === x$0 ||
		(x$0 instanceof $c_Lgpu_ShaderDef &&
			this.cW === x$0.cW &&
			this.cV === x$0.cV)
	);
};
...
var $d_ju_concurrent_ExecutionException = new $TypeData().i(
	$c_ju_concurrent_ExecutionException,
...
function $f_sc_StrictOptimizedIterableOps__zip__sc_IterableOnce__O(
	$thiz,
	that,
) {
	var b = $thiz.cp().b3();
...
var $d_sci_Iterable$ = new $TypeData().i(
	$c_sci_Iterable$,
...
$p.aV = function () {
	return this.f6.l(this.dD.aV());
};
$p.b1 = function (elem) {
	return this.g9(elem);
};
$p.aS = function (elems) {
	return this.g2(elems);
};
...
var $d_s_concurrent_Future$$anon$4 = new $TypeData().i(
	$c_s_concurrent_Future$$anon$4,
	"scala.concurrent.Future$$anon$4",
	{
		dr: 1,
		f: 1,
		a: 1,
...
$p =
	$c_sjs_concurrent_QueueExecutionContext$PromisesExecutionContext.prototype =
		new $h_O();
$p.constructor =
	$c_sjs_concurrent_QueueExecutionContext$PromisesExecutionContext;
/** @constructor */
...
var $d_sjs_concurrent_QueueExecutionContext$PromisesExecutionContext =
	new $TypeData().i(
		$c_sjs_concurrent_QueueExecutionContext$PromisesExecutionContext,
...
$p =
	$c_sjs_concurrent_QueueExecutionContext$TimeoutsExecutionContext.prototype =
		new $h_O();
$p.constructor =
	$c_sjs_concurrent_QueueExecutionContext$TimeoutsExecutionContext;
/** @constructor */
...
var $d_sjs_concurrent_QueueExecutionContext$TimeoutsExecutionContext =
	new $TypeData().i(
		$c_sjs_concurrent_QueueExecutionContext$TimeoutsExecutionContext,
...
var $d_jl_NegativeArraySizeException = new $TypeData().i(
...
var $d_jl_StackOverflowError = new $TypeData().i(
	$c_jl_StackOverflowError,
...
$p.p = function () {
	return this.n()
		? $m_sc_Iterator$().a2
		: new $c_sc_Iterator$$anon$20(this.b2());
};
/** @constructor */
...
$p.H = function (x$1) {
	return (
		this === x$1 ||
		(x$1 instanceof $c_T2 &&
			$m_sr_BoxesRunTime$().i(this.aw, x$1.aw) &&
			$m_sr_BoxesRunTime$().i(this.ai, x$1.ai))
	);
};
...
$p.H = function (x$0) {
	return (
		this === x$0 ||
		(x$0 instanceof $c_T3 &&
			$m_sr_BoxesRunTime$().i(this.cF, x$0.cF) &&
			$m_sr_BoxesRunTime$().i(this.cG, x$0.cG) &&
			$m_sr_BoxesRunTime$().i(this.cH, x$0.cH))
	);
};
$p.bg = function () {
	return "Tuple3";
...
var $d_sc_Iterator$$anon$9 = new $TypeData().i(
	$c_sc_Iterator$$anon$9,
...
$p.h = function () {
	...
	if (this.aW > 0) {
		...
		return this.aW < 0 ? this.bQ.h() : $m_sc_Iterator$().a2.h();
	}
};
$p.dv = function (from, until) {
	var lo = from > 0 ? from : 0;
...
function $p_sc_LinearSeqOps__linearSeqEq$1__sc_LinearSeq__sc_LinearSeq__Z(
	...
	while (true) {
		if (a$tailLocal1 === b$tailLocal1) {
			...
			!a$tailLocal1.n() &&
			!b$tailLocal1.n() &&
			$m_sr_BoxesRunTime$().i(a$tailLocal1.am(), b$tailLocal1.am())
		) {
...
function $p_sci_ChampBaseIterator__searchNextValueNode__Z($thiz) {
	while ($thiz.aL >= 0) {
		...
		if (nodeCursor < $thiz.bC.a[lengthIndex]) {
			...
			if (nextNode.dU()) {
				$p_sci_ChampBaseIterator__setupPayloadNode__sci_Node__V(
					$thiz,
					nextNode,
				);
				return true;
...
$p.k = function () {
	return (
		this.aY < this.d4 || $p_sci_ChampBaseIterator__searchNextValueNode__Z(this)
	);
};
...
function $p_sci_ChampBaseReverseIterator__setupPayloadNode__sci_Node__V(
	$thiz,
	node,
) {
	$thiz.dB = node;
...
function $p_sci_ChampBaseReverseIterator__pushNode__sci_Node__V($thiz, node) {
	$thiz.aZ = (1 + $thiz.aZ) | 0;
	$thiz.d7.a[$thiz.aZ] = node;
	$thiz.d6.a[$thiz.aZ] = (-1 + node.eB()) | 0;
}
...
function $p_sci_ChampBaseReverseIterator__searchNextValueNode__Z($thiz) {
	while ($thiz.aZ >= 0) {
		var nodeCursor = $thiz.d6.a[$thiz.aZ];
		$thiz.d6.a[$thiz.aZ] = (-1 + nodeCursor) | 0;
		if (nodeCursor >= 0) {
			$p_sci_ChampBaseReverseIterator__pushNode__sci_Node__V(
				$thiz,
				$thiz.d7.a[$thiz.aZ].eu(nodeCursor),
			);
		} else {
			var currNode = $thiz.d7.a[$thiz.aZ];
			$p_sci_ChampBaseReverseIterator__popNode__V($thiz);
			if (currNode.dU()) {
				$p_sci_ChampBaseReverseIterator__setupPayloadNode__sci_Node__V(
					$thiz,
					currNode,
				);
				return true;
...
$p.k = function () {
	return (
		this.bR >= 0 ||
		$p_sci_ChampBaseReverseIterator__searchNextValueNode__Z(this)
	);
};
function $p_sci_HashMapBuilder__isAliased__Z($thiz) {
	return $thiz.cI !== null;
}
function $p_sci_HashMapBuilder__insertElement__AI__I__I__AI(
	$thiz,
	as,
	ix,
	elem,
	...
	if (ix < 0) {
		throw $ct_jl_ArrayIndexOutOfBoundsException__(
			new $c_jl_ArrayIndexOutOfBoundsException(),
		);
	}
	if (ix > as.a.length) {
...
function $p_sci_HashMapBuilder__insertValue__sci_BitmapIndexedMapNode__I__O__I__I__O__V(
	$thiz,
	bm,
	bitpos,
	key,
	...
	var length = (src.a.length - idx) | 0;
	src.j(idx, dst, destPos, length);
	var dstHashes = $p_sci_HashMapBuilder__insertElement__AI__I__I__AI(
		$thiz,
		bm.aK,
		dataIx,
		originalHash,
...
function $c_sci_HashMapBuilder() {
	this.cI = null;
	this.bt = null;
	this.bt = new $c_sci_BitmapIndexedMapNode(
		0,
		0,
		$m_s_Array$EmptyArrays$().eM,
		$m_s_Array$EmptyArrays$().e5,
		0,
		0,
	);
...
$p.cT = function (mapNode, key, value, originalHash, keyHash, shift) {
	if (mapNode instanceof $c_sci_BitmapIndexedMapNode) {
		...
		if ((mapNode.F & bitpos) !== 0) {
			...
			$p_sci_HashMapBuilder__insertValue__sci_BitmapIndexedMapNode__I__O__I__I__O__V(
				this,
				mapNode,
				bitpos,
				key,
...
$p.fr = function (xs) {
	...
	if (xs instanceof $c_sci_HashMap) {
		...
		while (iter.k()) {
			var next = iter.h();
			var originalHash = xs.ho(next.gN());
			var hash = $m_sc_Hashing$().bq(originalHash);
			this.cT(this.bt, next.gX(), next.fY(), originalHash, hash, 0);
		}
	} else if (false) {
		var iter$2 = xs.hw();
		while (iter$2.k()) {
			var next$2 = iter$2.h();
			var originalHash$2 = xs.ho(next$2.gN());
			var hash$2 = $m_sc_Hashing$().bq(originalHash$2);
			this.cT(this.bt, next$2.gX(), next$2.fY(), originalHash$2, hash$2, 0);
		}
	} else if ($is_sci_Map(xs)) {
		xs.cn(
			new $c_sr_AbstractFunction2_$$Lambda$286cbfc6187197affcadc8465aaec93d6b7d20dc(
				(key$2, value$2) => this.ch(key$2, value$2),
			),
		);
	} else {
		var it = xs.p();
...
var $d_sci_HashMapBuilder = new $TypeData().i(
	$c_sci_HashMapBuilder,
...
$p.fO = function () {
	return this.d8 ? this.ce.fN() : this.bG;
};
$p.g6 = function (key, value) {
	if (this.d8) {
...
$p.b1 = function (elem) {
	return this.g6(elem.aw, elem.ai);
};
$p.aS = function (elems) {
	return this.fs(elems);
};
var $d_sci_MapBuilderImpl = new $TypeData().i(
...
$p.fC = function (it) {
	if (it instanceof $c_sci_Vector) {
		...
		if (knownSize === 0) {
			...
			return new $c_sci_VectorBuilder().ft(it).fP();
		}
	}
};
$p.cQ = function (source) {
...
var $d_sci_Vector$ = new $TypeData().i(
	$c_sci_Vector$,
...
function $p_sci_VectorBuilder__addVector__sci_Vector__sci_VectorBuilder(
	$thiz,
	xs,
) {
...
$p.gT = function (v) {
	...
	switch (x28) {
		...
		case 7: {
			...
			this.z.a[0] = $m_sci_VectorStatics$().bx(
				$m_sci_VectorStatics$().bx(v.b, v.ax),
				v.ay,
			);
			var dest$2 = this.z;
		...
		case 9: {
			...
			this.E.a[0] = $m_sci_VectorStatics$().bx(
				$m_sci_VectorStatics$().bx($m_sci_VectorStatics$().bx(v.b, v.aj), v.ak),
				v.al,
			);
			var dest$3 = this.E;
		...
		case 11: {
			...
			this.ag.a[0] = $m_sci_VectorStatics$().bx(
				$m_sci_VectorStatics$().bx(
					$m_sci_VectorStatics$().bx(
						$m_sci_VectorStatics$().bx(v.b, v.a8),
						v.a9,
					),
					v.aa,
				),
...
$p.ft = function (xs) {
	return xs instanceof $c_sci_Vector
		? this.u === 0 && this.m === 0 && !this.dC
			? this.gT(xs)
			: $p_sci_VectorBuilder__addVector__sci_Vector__sci_VectorBuilder(this, xs)
		: $f_scm_Growable__addAll__sc_IterableOnce__scm_Growable(this, xs);
};
$p.fP = function () {
	if (this.dC) {
	...
	if (realLen === 0) {
		...
		throw $ct_jl_IndexOutOfBoundsException__T__(
			new $c_jl_IndexOutOfBoundsException(),
			"Vector cannot have negative size " + len,
		);
	} else if (len <= 32) {
		var a = this.B;
		return new $c_sci_Vector1(
			a.a.length === realLen ? a : $m_ju_Arrays$().G(a, realLen),
		);
	} else if (len <= 1024) {
		var i1 = 31 & ((-1 + len) | 0);
		var i2 = (((-1 + len) | 0) >>> 5) | 0;
		...
		var len$2 = (1 + i1$2) | 0;
		var suffix1$2 =
			a$3.a.length === len$2 ? a$3 : $m_ju_Arrays$().G(a$3, len$2);
		var len1 = prefix1$2.a.length;
		return new $c_sci_Vector3(
			prefix1$2,
			len1,
			prefix2,
			(len1 + (prefix2.a.length << 5)) | 0,
			data$2,
			suffix2,
			suffix1$2,
			realLen,
		...
		var len$3 = (1 + i1$3) | 0;
		var suffix1$3 =
			a$6.a.length === len$3 ? a$6 : $m_ju_Arrays$().G(a$6, len$3);
		var len1$2 = prefix1$3.a.length;
		var len12$2 = (len1$2 + (prefix2$2.a.length << 5)) | 0;
		return new $c_sci_Vector4(
			prefix1$3,
			len1$2,
			prefix2$2,
			len12$2,
			prefix3,
			(len12$2 + (prefix3.a.length << 10)) | 0,
			data$3,
			suffix3,
			suffix2$2,
			suffix1$3,
		...
		var len$4 = (1 + i1$4) | 0;
		var suffix1$4 =
			a$10.a.length === len$4 ? a$10 : $m_ju_Arrays$().G(a$10, len$4);
		...
		return new $c_sci_Vector5(
			...
			len123$2,
			prefix4,
			(len123$2 + (prefix4.a.length << 15)) | 0,
			data$4,
			suffix4,
			suffix3$2,
			suffix2$3,
		...
		var suffix2$4 = $m_ju_Arrays$().G(
			this.ag.a[i6].a[i5$2].a[i4$3].a[i3$4],
			i2$5,
		);
		var a$15 = this.ag.a[i6].a[i5$2].a[i4$3].a[i3$4].a[i2$5];
		var len$5 = (1 + i1$5) | 0;
		var suffix1$5 =
			a$15.a.length === len$5 ? a$15 : $m_ju_Arrays$().G(a$15, len$5);
		...
		return new $c_sci_Vector6(
			...
			len1234$2,
			prefix5,
			(len1234$2 + (prefix5.a.length << 20)) | 0,
			data$5,
			suffix5,
			suffix4$2,
			suffix3$3,
...
var $d_sci_VectorBuilder = new $TypeData().i(
	$c_sci_VectorBuilder,
...
$p.es = function (runnable) {
	$f_s_concurrent_BatchingExecutor__submitSyncBatched__jl_Runnable__V(
		this,
		runnable,
	);
};
...
var $d_s_concurrent_ExecutionContext$parasitic$ = new $TypeData().i(
	$c_s_concurrent_ExecutionContext$parasitic$,
...
function $m_s_concurrent_ExecutionContext$parasitic$() {
	if (!$n_s_concurrent_ExecutionContext$parasitic$) {
		$n_s_concurrent_ExecutionContext$parasitic$ =
			new $c_s_concurrent_ExecutionContext$parasitic$();
	}
...
$p.gH = function (source) {
	return this.b3().aS(source).aV();
};
$p.b3 = function () {
	return new $c_scm_Builder$$anon$1(
		new $c_sr_AbstractFunction1_$$Lambda$70e1780b84463d18653aacefee3ab989ac625f28(
			(x$1$2$2) => new $c_sjsr_WrappedVarArgs(x$1$2$2.c2),
		),
...
$p.fL = function (pf) {
	...
	try {
		...
		var e$2 =
			e instanceof $c_jl_Throwable ? e : new $c_sjs_js_JavaScriptException(e);
		var x18 = $m_s_util_control_NonFatal$().hn(e$2);
		if (!x18.n()) {
			return new $c_s_util_Failure(x18.b2());
		}
		throw e$2 instanceof $c_sjs_js_JavaScriptException ? e$2.bp : e$2;
	}
};
function $isArrayOf_s_util_Failure(obj, depth) {
	return !!(
		...
		obj.$classData &&
		obj.$classData.D === depth &&
		obj.$classData.B.n.b7
	);
}
var $d_s_util_Failure = new $TypeData().i(
	$c_s_util_Failure,
	"scala.util.Failure",
	{
		b7: 1,
...
$p.H = function (x$0) {
	return (
		this === x$0 ||
		(x$0 instanceof $c_s_util_Success &&
			$m_sr_BoxesRunTime$().i(this.cN, x$0.cN))
	);
};
$p.A = function () {
	return $m_sr_ScalaRunTime$().dO(this);
...
function $isArrayOf_s_util_Success(obj, depth) {
	return !!(
		...
		obj.$classData &&
		obj.$classData.D === depth &&
		obj.$classData.B.n.b8
	);
}
var $d_s_util_Success = new $TypeData().i(
	$c_s_util_Success,
	"scala.util.Success",
	{
		b8: 1,
...
var $d_jl_ArrayIndexOutOfBoundsException = new $TypeData().i(
...
function $f_jl_Long__toString__T($thiz) {
	return $m_RTLong$().fK($thiz.f, $thiz.g);
}
...
$p.H = function (x$0) {
	return (
		this === x$0 ||
		(x$0 instanceof $c_s_Some && $m_sr_BoxesRunTime$().i(this.cE, x$0.cE))
	);
};
$p.A = function () {
	return $m_sr_ScalaRunTime$().dO(this);
...
function $c_sci_HashMapBuilder$$anon$1(hm$1, outer) {
	...
	while (this.k()) {
		var originalHash = this.cc.dn(this.aY);
		outer.cT(
			outer.bt,
			this.cc.c8(this.aY),
			this.cc.bM(this.aY),
...
var $d_sci_HashMapBuilder$$anon$1 = new $TypeData().i(
	$c_sci_HashMapBuilder$$anon$1,
	"scala.collection.immutable.HashMapBuilder$$anon$1",
	{
		cu: 1,
		aJ: 1,
		n: 1,
...
var $d_sci_Map$Map2$$anon$1 = new $TypeData().i(
	$c_sci_Map$Map2$$anon$1,
...
var $d_sci_Map$Map3$$anon$4 = new $TypeData().i(
	$c_sci_Map$Map3$$anon$4,
...
var $d_sci_Map$Map4$$anon$7 = new $TypeData().i(
	$c_sci_Map$Map4$$anon$7,
...
$p = $c_sci_MapKeyValueTupleHashIterator.prototype =
	new $h_sci_ChampBaseReverseIterator();
...
$p.I = function () {
	return $m_s_util_hashing_MurmurHash3$().fU(
		this.ea,
		$m_sr_Statics$().ac(this.f0),
		-889275714,
	);
};
$p.h6 = function () {
...
var $d_sci_MapKeyValueTupleHashIterator = new $TypeData().i(
	$c_sci_MapKeyValueTupleHashIterator,
...
$p.h5 = function () {
	...
	var payload = this.cc.fE(this.aY);
	this.aY = (1 + this.aY) | 0;
	return payload;
};
$p.h = function () {
...
var $d_sci_MapKeyValueTupleIterator = new $TypeData().i(
...
function $p_sci_NewVectorIterator__advanceSlice__V($thiz) {
	...
	$thiz.cg =
		($thiz.d9 +
			Math.imul(slice.a.length, 1 << Math.imul(5, (-1 + $thiz.bZ) | 0))) |
		0;
	if ($thiz.cg > $thiz.bI) {
		$thiz.cg = $thiz.bI;
	}
...
var $d_sci_NewVectorIterator = new $TypeData().i(
...
class $c_s_concurrent_Future$$anon$1 extends $c_ju_NoSuchElementException {
	constructor(t$2) {
		...
		$ct_jl_Throwable__T__jl_Throwable__Z__Z__(
			this,
			"Future.collect partial function is not defined at: " + t$2,
			null,
			true,
			true,
		);
...
var $d_s_concurrent_Future$$anon$1 = new $TypeData().i(
	$c_s_concurrent_Future$$anon$1,
	"scala.concurrent.Future$$anon$1",
	{
		dn: 1,
		a1: 1,
		q: 1,
...
var $d_s_concurrent_Future$$anon$2 = new $TypeData().i(
	$c_s_concurrent_Future$$anon$2,
	"scala.concurrent.Future$$anon$2",
	{
		dp: 1,
		a1: 1,
		q: 1,
...
var $d_s_concurrent_Future$$anon$3 = new $TypeData().i(
	$c_s_concurrent_Future$$anon$3,
	"scala.concurrent.Future$$anon$3",
	{
		dq: 1,
		a1: 1,
		q: 1,
...
function $ct_s_concurrent_impl_Promise$DefaultPromise__s_util_Try__(
	$thiz,
	result,
) {
	$ct_s_concurrent_impl_Promise$DefaultPromise__O__(
		$thiz,
		$m_s_concurrent_impl_Promise$().dt(result),
	);
	return $thiz;
}
function $ct_s_concurrent_impl_Promise$DefaultPromise__($thiz) {
	$ct_s_concurrent_impl_Promise$DefaultPromise__O__(
		$thiz,
		$m_s_concurrent_impl_Promise$().de,
	);
	return $thiz;
}
function $p_s_concurrent_impl_Promise$DefaultPromise__value0__s_util_Try(
	$thiz,
) {
...
function $p_s_concurrent_impl_Promise$DefaultPromise__dispatchOrAddCallbacks__O__s_concurrent_impl_Promise$Callbacks__s_concurrent_impl_Promise$Callbacks(
	$thiz,
	state,
	callbacks,
) {
	...
	while (true) {
		if (state$tailLocal2 instanceof $c_s_util_Try) {
			$p_s_concurrent_impl_Promise$DefaultPromise__submitWithValue__s_concurrent_impl_Promise$Callbacks__s_util_Try__V(
				δthis$tailLocal4,
				callbacks,
				state$tailLocal2,
			);
			...
			if (
				δthis$tailLocal4.dk(
					state$tailLocal2,
					state$tailLocal2 !== $m_s_concurrent_impl_Promise$().de
						? $p_s_concurrent_impl_Promise$DefaultPromise__concatCallbacks__s_concurrent_impl_Promise$Callbacks__s_concurrent_impl_Promise$Callbacks__s_concurrent_impl_Promise$Callbacks(
								δthis$tailLocal4,
								callbacks,
								state$tailLocal2,
							)
...
function $p_s_concurrent_impl_Promise$DefaultPromise__concatCallbacks__s_concurrent_impl_Promise$Callbacks__s_concurrent_impl_Promise$Callbacks__s_concurrent_impl_Promise$Callbacks(
	$thiz,
	left,
	right,
) {
	...
	while (true) {
		if (
			left$tailLocal1 instanceof $c_s_concurrent_impl_Promise$Transformation
		) {
			return new $c_s_concurrent_impl_Promise$ManyCallbacks(
				left$tailLocal1,
				right$tailLocal1,
			);
		} else {
			...
			var right$tailLocal1$tmp1 =
				new $c_s_concurrent_impl_Promise$ManyCallbacks(m.ei, right$tailLocal1);
			left$tailLocal1 = left$tailLocal1$tmp1;
			right$tailLocal1 = right$tailLocal1$tmp1;
		}
	}
}
function $p_s_concurrent_impl_Promise$DefaultPromise__submitWithValue__s_concurrent_impl_Promise$Callbacks__s_util_Try__V(
	$thiz,
	callbacks,
	resolved,
) {
	...
	while (true) {
		if (
			callbacks$tailLocal1 instanceof $c_s_concurrent_impl_Promise$ManyCallbacks
		) {
			var m = callbacks$tailLocal1;
			m.ei.fR(resolved);
			callbacks$tailLocal1 = m.ej;
		} else {
			callbacks$tailLocal1.fR(resolved);
			return void 0;
		}
	}
}
...
$p = $c_s_concurrent_impl_Promise$DefaultPromise.prototype =
	new $h_ju_concurrent_atomic_AtomicReference();
...
$p.hl = function (f, executor) {
	return $p_s_concurrent_impl_Promise$DefaultPromise__dispatchOrAddCallbacks__O__s_concurrent_impl_Promise$Callbacks__s_concurrent_impl_Promise$Callbacks(
		this,
		this.y,
		$ct_s_concurrent_impl_Promise$Transformation__I__F1__s_concurrent_ExecutionContext__(
			new $c_s_concurrent_impl_Promise$Transformation(),
...
$p.fA = function (f, executor) {
	var state = this.y;
	if (!(state instanceof $c_s_util_Failure)) {
		$p_s_concurrent_impl_Promise$DefaultPromise__dispatchOrAddCallbacks__O__s_concurrent_impl_Promise$Callbacks__s_concurrent_impl_Promise$Callbacks(
			this,
			state,
			$ct_s_concurrent_impl_Promise$Transformation__I__F1__s_concurrent_ExecutionContext__(
				new $c_s_concurrent_impl_Promise$Transformation(),
...
$p.gE = function (f, executor) {
	var state = this.y;
	return !(state instanceof $c_s_util_Failure)
		? $p_s_concurrent_impl_Promise$DefaultPromise__dispatchOrAddCallbacks__O__s_concurrent_impl_Promise$Callbacks__s_concurrent_impl_Promise$Callbacks(
				this,
				state,
				$ct_s_concurrent_impl_Promise$Transformation__I__F1__s_concurrent_ExecutionContext__(
...
$p.gD = function () {
	return !(this.y instanceof $c_s_util_Success)
		? this.hl(
				$m_s_concurrent_Future$().fd,
				$m_s_concurrent_ExecutionContext$parasitic$(),
			)
		: $m_s_concurrent_Future$().ff;
};
$p.A = function () {
...
$p.hm = function (value) {
	var state = this.y;
	return (
		!(state instanceof $c_s_util_Try) &&
		this.cw(state, $m_s_concurrent_impl_Promise$().dt(value))
	);
};
	...
	if (other !== this) {
		...
		if (!(state instanceof $c_s_util_Try)) {
			if (other instanceof $c_s_concurrent_impl_Promise$DefaultPromise) {
				var resolved =
					$p_s_concurrent_impl_Promise$DefaultPromise__value0__s_util_Try(
						other,
					);
			} else {
				var this$1 = $m_s_Option$().gf(
					$p_s_concurrent_impl_Promise$DefaultPromise__value0__s_util_Try(
						other,
					),
				);
				var resolved = this$1.n() ? null : this$1.b2();
			}
			if (resolved !== null) {
	...
	while (true) {
		if (δthis$tailLocal5 !== target$tailLocal2) {
			...
			if (state instanceof $c_s_util_Try) {
				...
				var l =
					link$tailLocal1 !== null
						? link$tailLocal1
						: new $c_s_concurrent_impl_Promise$Link(target$tailLocal2);
...
var $d_s_concurrent_impl_Promise$DefaultPromise = new $TypeData().i(
	$c_s_concurrent_impl_Promise$DefaultPromise,
...
class $c_sjs_js_JavaScriptException extends $c_jl_RuntimeException {
	...
	H(x$1) {
		return (
			this === x$1 ||
			(x$1 instanceof $c_sjs_js_JavaScriptException &&
				$m_sr_BoxesRunTime$().i(this.bp, x$1.bp))
		);
	}
}
function $isArrayOf_sjs_js_JavaScriptException(obj, depth) {
	return !!(
		...
		obj.$classData &&
		obj.$classData.D === depth &&
		obj.$classData.B.n.b6
	);
}
var $d_sjs_js_JavaScriptException = new $TypeData().i(
...
$p = $c_s_reflect_ManifestFactory$IntManifest.prototype =
	new $h_s_reflect_AnyValManifest();
...
$p = $c_s_reflect_ManifestFactory$IntManifest$.prototype =
	new $h_s_reflect_ManifestFactory$IntManifest();
$p.constructor = $c_s_reflect_ManifestFactory$IntManifest$;
/** @constructor */
function $h_s_reflect_ManifestFactory$IntManifest$() {}
$h_s_reflect_ManifestFactory$IntManifest$.prototype = $p;
var $d_s_reflect_ManifestFactory$IntManifest$ = new $TypeData().i(
	$c_s_reflect_ManifestFactory$IntManifest$,
...
function $m_s_reflect_ManifestFactory$IntManifest$() {
	if (!$n_s_reflect_ManifestFactory$IntManifest$) {
		$n_s_reflect_ManifestFactory$IntManifest$ =
			new $c_s_reflect_ManifestFactory$IntManifest$();
	}
...
function $ct_s_concurrent_impl_Promise$Transformation__F1__s_concurrent_ExecutionContext__s_util_Try__I__(
	$thiz,
	_fun,
	_ec,
	_arg,
...
function $ct_s_concurrent_impl_Promise$Transformation__I__F1__s_concurrent_ExecutionContext__(
	$thiz,
	xform,
	f,
	ec,
) {
	$ct_s_concurrent_impl_Promise$Transformation__F1__s_concurrent_ExecutionContext__s_util_Try__I__(
		$thiz,
		f,
		ec,
		null,
...
function $p_s_concurrent_impl_Promise$Transformation__handleFailure__jl_Throwable__s_concurrent_ExecutionContext__V(
	$thiz,
	t,
	e,
) {
	...
	if (wasInterrupted || $m_s_util_control_NonFatal$().dQ(t)) {
		var completed = $thiz.cw(
			$thiz.y,
			$m_s_concurrent_impl_Promise$().dt(new $c_s_util_Failure(t)),
		);
...
$p = $c_s_concurrent_impl_Promise$Transformation.prototype =
	new $h_s_concurrent_impl_Promise$DefaultPromise();
...
$p.fR = function (resolved) {
	...
	try {
		...
		var e$3 =
			e$2 instanceof $c_jl_Throwable
				? e$2
				: new $c_sjs_js_JavaScriptException(e$2);
		this.dH = null;
		this.df = null;
		this.dg = null;
		if (e === null) {
		...
		$p_s_concurrent_impl_Promise$Transformation__handleFailure__jl_Throwable__s_concurrent_ExecutionContext__V(
			this,
			e$3,
			e,
		);
...
$p.cu = function () {
	...
	try {
		...
		switch (this.dh) {
			...
			case 1: {
				var resolvedResult =
					x$proxy4 instanceof $c_s_util_Success
						? new $c_s_util_Success(x$proxy5.l(x$proxy4.b2()))
						: x$proxy4;
				break;
			}
			case 2: {
				if (x$proxy4 instanceof $c_s_util_Success) {
					var f = x$proxy5.l(x$proxy4.b2());
			...
			case 3: {
				var resolvedResult = $m_s_concurrent_impl_Promise$().dt(
					x$proxy5.l(x$proxy4),
				);
				break;
			}
			...
			case 7: {
				var resolvedResult =
					x$proxy4 instanceof $c_s_util_Failure
						? $m_s_concurrent_impl_Promise$().dt(x$proxy4.fL(x$proxy5))
						: x$proxy4;
				break;
			}
			case 8: {
				if (x$proxy4 instanceof $c_s_util_Failure) {
					...
					var resolvedResult =
						f$3 !== $m_s_concurrent_Future$().eh
							? (f$3 instanceof $c_s_concurrent_impl_Promise$DefaultPromise
									? f$3.ez(this, null)
									: this.ep(f$3),
								null)
							: x$proxy4;
			...
			case 9: {
				var resolvedResult =
					x$proxy4 instanceof $c_s_util_Failure || !!x$proxy5.l(x$proxy4.b2())
						? x$proxy4
						: $m_s_concurrent_Future$().fg;
				break;
			}
			case 10: {
				var resolvedResult =
					x$proxy4 instanceof $c_s_util_Success
						? new $c_s_util_Success(
								x$proxy5.dj(x$proxy4.b2(), $m_s_concurrent_Future$().fe),
							)
						: x$proxy4;
				break;
			}
			default: {
				var resolvedResult = new $c_s_util_Failure(
					new $c_jl_IllegalStateException(
						"BUG: encountered transformation promise with illegal type: " +
							this.dh,
					),
				);
			}
...
function $isArrayOf_s_concurrent_impl_Promise$Transformation(obj, depth) {
	return !!(
		...
		obj.$classData &&
		obj.$classData.D === depth &&
		obj.$classData.B.n.b5
	);
}
var $d_s_concurrent_impl_Promise$Transformation = new $TypeData().i(
	$c_s_concurrent_impl_Promise$Transformation,
...
$p.dP = function (sb, start, sep, end) {
	return $f_sc_MapOps__addString__scm_StringBuilder__T__T__T__scm_StringBuilder(
		this,
		sb,
		start,
		sep,
...
var $d_sci_Map$EmptyMap$ = new $TypeData().i(
	$c_sci_Map$EmptyMap$,
...
$p.cx = function (key, value) {
	return $m_sr_BoxesRunTime$().i(key, this.bu)
		? new $c_sci_Map$Map1(this.bu, value)
		: new $c_sci_Map$Map2(this.bu, this.cd, key, value);
};
$p.dm = function (p) {
...
function $isArrayOf_sci_Map$Map1(obj, depth) {
	return !!(
		...
		obj.$classData &&
		obj.$classData.D === depth &&
		obj.$classData.B.n.aO
	);
}
var $d_sci_Map$Map1 = new $TypeData().i(
	$c_sci_Map$Map1,
...
$p.ck = function (key) {
	return (
		$m_sr_BoxesRunTime$().i(key, this.bi) ||
		$m_sr_BoxesRunTime$().i(key, this.bj)
	);
};
$p.co = function (key, default$1) {
	return $m_sr_BoxesRunTime$().i(key, this.bi)
		? this.bT
		: $m_sr_BoxesRunTime$().i(key, this.bj)
			? this.bU
			: default$1.aT();
...
$p.cx = function (key, value) {
	return $m_sr_BoxesRunTime$().i(key, this.bi)
		? new $c_sci_Map$Map2(this.bi, value, this.bj, this.bU)
		: $m_sr_BoxesRunTime$().i(key, this.bj)
			? new $c_sci_Map$Map2(this.bi, this.bT, this.bj, value)
			: new $c_sci_Map$Map3(this.bi, this.bT, this.bj, this.bU, key, value);
};
$p.dm = function (p) {
	return (
		!!p.l(new $c_T2(this.bi, this.bT)) && !!p.l(new $c_T2(this.bj, this.bU))
	);
};
$p.I = function () {
	var a = 0;
...
function $isArrayOf_sci_Map$Map2(obj, depth) {
	return !!(
		...
		obj.$classData &&
		obj.$classData.D === depth &&
		obj.$classData.B.n.aP
	);
}
var $d_sci_Map$Map2 = new $TypeData().i(
	$c_sci_Map$Map2,
...
$p.ck = function (key) {
	return (
		$m_sr_BoxesRunTime$().i(key, this.b8) ||
		$m_sr_BoxesRunTime$().i(key, this.b9) ||
		$m_sr_BoxesRunTime$().i(key, this.ba)
	);
};
$p.co = function (key, default$1) {
	return $m_sr_BoxesRunTime$().i(key, this.b8)
		? this.bD
		: $m_sr_BoxesRunTime$().i(key, this.b9)
			? this.bE
			: $m_sr_BoxesRunTime$().i(key, this.ba)
...
$p.cx = function (key, value) {
	return $m_sr_BoxesRunTime$().i(key, this.b8)
		? new $c_sci_Map$Map3(this.b8, value, this.b9, this.bE, this.ba, this.bF)
		: $m_sr_BoxesRunTime$().i(key, this.b9)
			? new $c_sci_Map$Map3(this.b8, this.bD, this.b9, value, this.ba, this.bF)
			: $m_sr_BoxesRunTime$().i(key, this.ba)
				? new $c_sci_Map$Map3(
						this.b8,
						this.bD,
...
$p.dm = function (p) {
	return (
		!!p.l(new $c_T2(this.b8, this.bD)) &&
		!!p.l(new $c_T2(this.b9, this.bE)) &&
		!!p.l(new $c_T2(this.ba, this.bF))
	);
};
$p.I = function () {
	var a = 0;
...
function $isArrayOf_sci_Map$Map3(obj, depth) {
	return !!(
		...
		obj.$classData &&
		obj.$classData.D === depth &&
		obj.$classData.B.n.aQ
	);
}
var $d_sci_Map$Map3 = new $TypeData().i(
	$c_sci_Map$Map3,
...
$p.ck = function (key) {
	return (
		$m_sr_BoxesRunTime$().i(key, this.aM) ||
		$m_sr_BoxesRunTime$().i(key, this.aN) ||
		$m_sr_BoxesRunTime$().i(key, this.aO) ||
		$m_sr_BoxesRunTime$().i(key, this.aP)
	);
};
$p.co = function (key, default$1) {
	return $m_sr_BoxesRunTime$().i(key, this.aM)
		? this.bk
		: $m_sr_BoxesRunTime$().i(key, this.aN)
			? this.bl
			: $m_sr_BoxesRunTime$().i(key, this.aO)
...
$p.dm = function (p) {
	return (
		!!p.l(new $c_T2(this.aM, this.bk)) &&
		!!p.l(new $c_T2(this.aN, this.bl)) &&
		!!p.l(new $c_T2(this.aO, this.bm)) &&
		!!p.l(new $c_T2(this.aP, this.bn))
	);
};
...
var $d_sci_Map$Map4 = new $TypeData().i(
	$c_sci_Map$Map4,
...
$p.p = function () {
	return this.n()
		? $m_sc_Iterator$().a2
		: new $c_sci_MapKeyValueTupleIterator(this.aD);
};
$p.ck = function (key) {
...
$p.cU = function (key, value) {
	var keyUnimprovedHash = $m_sr_Statics$().ac(key);
	var newRootNode = this.aD.fW(
		key,
		value,
		keyUnimprovedHash,
		$m_sc_Hashing$().bq(keyUnimprovedHash),
		0,
		true,
	);
...
$p.I = function () {
	if (this.n()) {
		...
		return $m_s_util_hashing_MurmurHash3$().fV(
			hashIterator,
			$m_s_util_hashing_MurmurHash3$().c3,
		);
	}
};
$p.cj = function () {
...
$p.p = function () {
	return this === $m_sci_Vector0$()
		? $m_sci_Vector$().f4
		: new $c_sci_NewVectorIterator(this, this.w(), this.bA());
};
$p.cj = function () {
	return "Vector";
};
...
$p.gc = function (suffix) {
	return suffix instanceof $c_sci_List
		? suffix.fq(this)
...
var $d_sci_Vector1 = new $TypeData().i(
	$c_sci_Vector1,
...
function $c_sci_Vector0$() {
	...
	this.d = null;
	this.e = 0;
	$ct_sci_BigVector__AO__AO__I__(
		this,
		$m_sci_VectorStatics$().ed,
		$m_sci_VectorStatics$().ed,
		0,
	);
}
...
$p.H = function (o) {
	return (
		this === o ||
		(!(o instanceof $c_sci_Vector) && $f_sc_Seq__equals__O__Z(this, o))
	);
};
$p.ah = function (index) {
	return $ct_jl_IndexOutOfBoundsException__T__(
		new $c_jl_IndexOutOfBoundsException(),
		index + " is out of bounds (empty vector)",
	);
};
$p.C = function (i) {
	this.fv(i);
...
var $d_sci_Vector0$ = new $TypeData().i(
	$c_sci_Vector0$,
	...
	if (index >= 0 && index < this.e) {
		if (index >= this.b0) {
			...
			if (i2 < this.aF.a.length) {
				...
				a1c.a[i1] = elem;
				a2c.a[i2] = a1c;
				return new $c_sci_Vector2(this.b, this.b0, a2c, this.d, this.e);
			} else {
				var a1$1 = this.d;
				var a1c$1 = a1$1.c();
				a1c$1.a[i1] = elem;
				return new $c_sci_Vector2(this.b, this.b0, this.aF, a1c$1, this.e);
			}
		} else {
			var a1$2 = this.b;
			var a1c$2 = a1$2.c();
			a1c$2.a[index] = elem;
			return new $c_sci_Vector2(a1c$2, this.b0, this.aF, this.d, this.e);
		}
	} else {
		throw this.ah(index);
	}
...
$p.c4 = function (elem) {
	if (this.d.a.length < 32) {
		...
		return new $c_sci_Vector2(this.b, this.b0, this.aF, suffix1$3, length0$3);
	} else if (this.aF.a.length < 30) {
		var data2$4 = $m_sci_VectorStatics$().o(this.aF, this.d);
		var a = new $ac_O(1);
		a.a[0] = elem;
		var length0$4 = (1 + this.e) | 0;
		return new $c_sci_Vector2(this.b, this.b0, data2$4, a, length0$4);
	} else {
		var $x_5 = this.b;
		var $x_4 = this.b0;
		var $x_3 = this.aF;
...
var $d_sci_Vector2 = new $TypeData().i(
	$c_sci_Vector2,
...
$p.C = function (index) {
	if (index >= 0 && index < this.e) {
		...
		if (io >= 0) {
			...
			var i2 = 31 & ((io >>> 5) | 0);
			var i1 = 31 & io;
			return i3 < this.au.a.length
				? this.au.a[i3].a[i2].a[i1]
				: i2 < this.av.a.length
					? this.av.a[i2].a[i1]
					: this.d.a[i1];
...
$p.c4 = function (elem) {
	if (this.d.a.length < 32) {
		...
		var data3$7 = $m_sci_VectorStatics$().o(
			this.au,
			$m_sci_VectorStatics$().o(this.av, this.d),
		);
		var a$1 = new $ac_O(1);
		a$1.a[0] = elem;
...
var $d_sci_Vector3 = new $TypeData().i(
	$c_sci_Vector3,
...
$p.C = function (index) {
	if (index >= 0 && index < this.e) {
		...
		if (io >= 0) {
			...
			var i2 = 31 & ((io >>> 5) | 0);
			var i1 = 31 & io;
			return i4 < this.ad.a.length
				? this.ad.a[i4].a[i3].a[i2].a[i1]
				: i3 < this.af.a.length
					? this.af.a[i3].a[i2].a[i1]
					: i2 < this.ae.a.length
						? this.ae.a[i2].a[i1]
						: this.d.a[i1];
		} else if (index >= this.as) {
			var io$2 = (index - this.as) | 0;
			return this.ay.a[(io$2 >>> 10) | 0].a[31 & ((io$2 >>> 5) | 0)].a[
				31 & io$2
			];
...
$p.c4 = function (elem) {
	if (this.d.a.length < 32) {
		...
		var suffix3$9 = $m_sci_VectorStatics$().o(
			this.af,
			$m_sci_VectorStatics$().o(this.ae, this.d),
		);
		var a$1 = new $ac_O(1);
		a$1.a[0] = elem;
		...
		var data4$10 = $m_sci_VectorStatics$().o(
			this.ad,
			$m_sci_VectorStatics$().o(
				this.af,
				$m_sci_VectorStatics$().o(this.ae, this.d),
			),
		);
...
var $d_sci_Vector4 = new $TypeData().i(
	$c_sci_Vector4,
...
$p.C = function (index) {
	if (index >= 0 && index < this.e) {
		...
		if (io >= 0) {
			...
			var i2 = 31 & ((io >>> 5) | 0);
			var i1 = 31 & io;
			return i5 < this.S.a.length
				? this.S.a[i5].a[i4].a[i3].a[i2].a[i1]
				: i4 < this.V.a.length
					? this.V.a[i4].a[i3].a[i2].a[i1]
					: i3 < this.U.a.length
						? this.U.a[i3].a[i2].a[i1]
						: i2 < this.T.a.length
							? this.T.a[i2].a[i1]
							: this.d.a[i1];
		} else if (index >= this.a6) {
			var io$2 = (index - this.a6) | 0;
			return this.al.a[(io$2 >>> 15) | 0].a[31 & ((io$2 >>> 10) | 0)].a[
				31 & ((io$2 >>> 5) | 0)
			].a[31 & io$2];
		} else if (index >= this.a5) {
			var io$3 = (index - this.a5) | 0;
			return this.ak.a[(io$3 >>> 10) | 0].a[31 & ((io$3 >>> 5) | 0)].a[
				31 & io$3
			];
...
$p.c4 = function (elem) {
	if (this.d.a.length < 32) {
		...
		var suffix3$29 = $m_sci_VectorStatics$().o(
			this.U,
			$m_sci_VectorStatics$().o(this.T, this.d),
		);
		var a$1 = new $ac_O(1);
		a$1.a[0] = elem;
		...
		var suffix4$12 = $m_sci_VectorStatics$().o(
			this.V,
			$m_sci_VectorStatics$().o(
				this.U,
				$m_sci_VectorStatics$().o(this.T, this.d),
		...
		var data5$13 = $m_sci_VectorStatics$().o(
			this.S,
			$m_sci_VectorStatics$().o(
				this.V,
				$m_sci_VectorStatics$().o(
...
var $d_sci_Vector5 = new $TypeData().i(
	$c_sci_Vector5,
...
$p.C = function (index) {
	if (index >= 0 && index < this.e) {
		...
		if (io >= 0) {
			...
			var i2 = 31 & ((io >>> 5) | 0);
			var i1 = 31 & io;
			return i6 < this.J.a.length
				? this.J.a[i6].a[i5].a[i4].a[i3].a[i2].a[i1]
				: i5 < this.N.a.length
					? this.N.a[i5].a[i4].a[i3].a[i2].a[i1]
					: i4 < this.M.a.length
						? this.M.a[i4].a[i3].a[i2].a[i1]
						: i3 < this.L.a.length
							? this.L.a[i3].a[i2].a[i1]
							: i2 < this.K.a.length
								? this.K.a[i2].a[i1]
								: this.d.a[i1];
		} else if (index >= this.Z) {
			var io$2 = (index - this.Z) | 0;
			return this.ab.a[(io$2 >>> 20) | 0].a[31 & ((io$2 >>> 15) | 0)].a[
				31 & ((io$2 >>> 10) | 0)
			].a[31 & ((io$2 >>> 5) | 0)].a[31 & io$2];
		} else if (index >= this.Y) {
			var io$3 = (index - this.Y) | 0;
			return this.aa.a[(io$3 >>> 15) | 0].a[31 & ((io$3 >>> 10) | 0)].a[
				31 & ((io$3 >>> 5) | 0)
			].a[31 & io$3];
		} else if (index >= this.X) {
			var io$4 = (index - this.X) | 0;
			return this.a9.a[(io$4 >>> 10) | 0].a[31 & ((io$4 >>> 5) | 0)].a[
				31 & io$4
			];
...
$p.c4 = function (elem) {
	if (this.d.a.length < 32) {
		...
		var suffix3$52 = $m_sci_VectorStatics$().o(
			this.L,
			$m_sci_VectorStatics$().o(this.K, this.d),
		);
		var a$1 = new $ac_O(1);
		a$1.a[0] = elem;
		...
		var suffix4$36 = $m_sci_VectorStatics$().o(
			this.M,
			$m_sci_VectorStatics$().o(
				this.L,
				$m_sci_VectorStatics$().o(this.K, this.d),
		...
		var suffix5$15 = $m_sci_VectorStatics$().o(
			this.N,
			$m_sci_VectorStatics$().o(
				this.M,
				$m_sci_VectorStatics$().o(
		...
		var data6$16 = $m_sci_VectorStatics$().o(
			this.J,
			$m_sci_VectorStatics$().o(
				this.N,
				$m_sci_VectorStatics$().o(
...
var $d_sci_Vector6 = new $TypeData().i(
	$c_sci_Vector6,
