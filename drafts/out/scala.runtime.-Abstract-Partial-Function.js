...
$p = $c_sr_AbstractPartialFunction.prototype = new $j_java$002elang$002e$002dObject.$h_O();
...
$p.f = (function(x) {
  return this.bD(x, $j_scala$002e$002dPartial$002dFunction$0024.$m_s_PartialFunction$().bm);
});
