...
function $p_Lbuffer\uff3ftriangle_BufferTriangle$__render$1__sr_DoubleRef__Lgpu_buffers_BufferBinding__Lwebgpu_GPUDevice__Lwebgpu_GPUCanvasContext__Lwebgpu_GPURenderPipeline__Lwebgpu_GPUBindGroup__Lwebgpu_GPUBuffer__D__V($thiz, startTime$1, tintColor$1, device$2, context$1, pipeline$1, bindGroup$1, vertexBuffer$1, time) {
  ...
  var value$proxy15 = $j_gpu$002emath$002epackage$0024package$0024.$m_Lgpu_math_package$package$().z().w(r);
  var offset$proxy24 = (c.a8() | 0);
  var _1 = c.S();
  _1.setFloat32(offset$proxy24, value$proxy15, true);
  var value$proxy16 = $j_gpu$002emath$002epackage$0024package$0024.$m_Lgpu_math_package$package$().z().w(g);
  var offset$proxy25 = ((4 + (c.a8() | 0)) | 0);
  var _1$1 = c.S();
  _1$1.setFloat32(offset$proxy25, value$proxy16, true);
  var value$proxy17 = $j_gpu$002emath$002epackage$0024package$0024.$m_Lgpu_math_package$package$().z().w(b);
  ...
  var items$proxy38 = $x_3.bu(new ($j_scala$002escalajs$002ejs$002e$002dObject.$d_sjs_js_Object.r().C)([({
    "view": textureView,
    "loadOp": "clear",
    "storeOp": "store",
    "clearValue": _2
  ...
  var items$proxy39 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_webgpu$002e$002dG$002dP$002dU$002dCommand$002dBuffer.$d_Lwebgpu_GPUCommandBuffer.r().C)([commandEncoder.finish()]));
...
export { $p_Lbuffer\uff3ftriangle_BufferTriangle$__render$1__sr_DoubleRef__Lgpu_buffers_BufferBinding__Lwebgpu_GPUDevice__Lwebgpu_GPUCanvasContext__Lwebgpu_GPURenderPipeline__Lwebgpu_GPUBindGroup__Lwebgpu_GPUBuffer__D__V as $p_Lbuffer\uff3ftriangle_BufferTriangle$__render$1__sr_DoubleRef__Lgpu_buffers_BufferBinding__Lwebgpu_GPUDevice__Lwebgpu_GPUCanvasContext__Lwebgpu_GPURenderPipeline__Lwebgpu_GPUBindGroup__Lwebgpu_GPUBuffer__D__V };
/** @constructor */
...
$p.ct = (function() {
  ...
  var gpu = $j_webgpu$002e$002dWeb$002dG$002dP$002dU$0024.$m_Lwebgpu_WebGPU$().dK();
  if ((gpu === (void 0))) {
    ...
    this.dM(gpu, canvas, new $j_scala$002eruntime$002e$002dAbstract$002dFunction2$002e$0024$0024$002dLambda$0024286cbfc6187197affcadc8465aaec93d6b7d20dc.$c_sr_AbstractFunction2_$$Lambda$286cbfc6187197affcadc8465aaec93d6b7d20dc(((v1$2, v2$2) => {
...
$p.dM = (function(gpu, canvas, setStatus) {
  ...
  var f$proxy2 = new $j_java$002elang$002e$002dObject.$c_sr_AbstractFunction1_$$Lambda$70e1780b84463d18653aacefee3ab989ac625f28(((adapter$2) => {
    ...
    return promise$proxy2.then($j_scala$002escalajs$002ejs$002e$002dAny$0024.$m_sjs_js_Any$().bQ(f$proxy1));
  }));
  var result = promise$proxy3.then($j_scala$002escalajs$002ejs$002e$002dAny$0024.$m_sjs_js_Any$().bQ(f$proxy2));
  ...
  result.catch(((err$2) => {
    if (pf$proxy1.dN(err$2)) {
      return pf$proxy1.cX(err$2, $j_scala$002e$002dPartial$002dFunction$0024.$m_s_PartialFunction$().cH);
    } else {
      var $x_1 = err$2;
      throw (($x_1 instanceof $j_java$002elang$002e$002dObject.$c_sjs_js_JavaScriptException) ? $x_1.bb : $x_1);
    }
  }));
});
$p.dP = (function(device, canvas, setStatus) {
  var context = $j_webgpu$002e$002dWeb$002dG$002dP$002dU$0024.$m_Lwebgpu_WebGPU$().dJ(canvas);
  context.configure(({
    "device": device,
    "format": "bgra8unorm"
  }));
  var triangleShader = new $j_gpu$002eshader$002e$002dShader$002dDef.$c_Lgpu_shader_ShaderDef($j_java$002elang$002e$002dObject.$m_sc_StringOps$().bV("\n        |  out.position = vec4<f32>(in.position, 0.0, 1.0);\n        |  out.color = in.color;\n        ", 124), $j_java$002elang$002e$002dObject.$m_sc_StringOps$().bV("\n        |  out.color = in.color * tintColor;\n        ", 124));
  ...
  var items$proxy1 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_java$002elang$002e$002dObject.$d_T.r().C)(["position"]));
  ...
  var items$proxy2 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_java$002elang$002e$002dObject.$d_T.r().C)(["color"]));
  var $x_32 = $j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy2);
  var items$proxy3 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_java$002elang$002e$002dObject.$d_T.r().C)([]));
  var $x_31 = $x_35.q([...$x_34], $x_33.q([...$x_32], [...$j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy3)]));
  var $x_30 = $j_scala$002escalajs$002ejs$002e$002dArray$002dOps$002dCommon$0024.$m_sjs_js_ArrayOpsCommon$();
  var items$proxy4 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_java$002elang$002e$002dObject.$d_T.r().C)(["vec2<f32>"]));
  ...
  var items$proxy5 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_java$002elang$002e$002dObject.$d_T.r().C)(["vec4<f32>"]));
  var $x_27 = $j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy5);
  var items$proxy6 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_java$002elang$002e$002dObject.$d_T.r().C)([]));
  var $x_26 = $x_30.q([...$x_29], $x_28.q([...$x_27], [...$j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy6)]));
  var items$proxy7 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_scala$002e$002dTuple3.$d_T3.r().C)([]));
  ...
  var items$proxy8 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_java$002elang$002e$002dObject.$d_T.r().C)(["color"]));
  var $x_22 = $j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy8);
  var items$proxy9 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_java$002elang$002e$002dObject.$d_T.r().C)([]));
  var $x_21 = $x_23.q([...$x_22], [...$j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy9)]);
  var $x_20 = $j_scala$002escalajs$002ejs$002e$002dArray$002dOps$002dCommon$0024.$m_sjs_js_ArrayOpsCommon$();
  var items$proxy10 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_java$002elang$002e$002dObject.$d_T.r().C)(["vec4<f32>"]));
  var $x_19 = $j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy10);
  var items$proxy11 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_java$002elang$002e$002dObject.$d_T.r().C)([]));
  var $x_18 = $x_20.q([...$x_19], [...$j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy11)]);
  var $x_17 = $j_scala$002escalajs$002ejs$002e$002dArray$002dOps$002dCommon$0024.$m_sjs_js_ArrayOpsCommon$();
  var items$proxy12 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_scala$002e$002dTuple3.$d_T3.r().C)([new $j_scala$002e$002dTuple3.$c_T3("position", "position", "vec4<f32>")]));
  var $x_16 = $j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy12);
  var items$proxy13 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_scala$002e$002dTuple3.$d_T3.r().C)([]));
  var $x_15 = $j_gpu$002eshader$002ederive$0024.$p_Lgpu_shader_derive$__generateCombinedStructFromLists__T__sjs_js_Array__sjs_js_Array__sjs_js_Array__T($x_24, "VertexOutput", $x_21, $x_18, $x_17.q([...$x_16], [...$j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy13)]));
  ...
  var items$proxy14 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_java$002elang$002e$002dObject.$d_T.r().C)(["color"]));
  var $x_12 = $j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy14);
  var items$proxy15 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_java$002elang$002e$002dObject.$d_T.r().C)([]));
  var $x_11 = $x_13.q([...$x_12], [...$j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy15)]);
  var $x_10 = $j_scala$002escalajs$002ejs$002e$002dArray$002dOps$002dCommon$0024.$m_sjs_js_ArrayOpsCommon$();
  var items$proxy16 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_java$002elang$002e$002dObject.$d_T.r().C)(["vec4<f32>"]));
  var $x_9 = $j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy16);
  var items$proxy17 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_java$002elang$002e$002dObject.$d_T.r().C)([]));
  var $x_8 = $x_10.q([...$x_9], [...$j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy17)]);
  var items$proxy18 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_scala$002e$002dTuple3.$d_T3.r().C)([]));
  ...
  var items$proxy19 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_java$002elang$002e$002dObject.$d_T.r().C)(["tintColor"]));
  var $x_4 = $j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy19);
  var items$proxy20 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_java$002elang$002e$002dObject.$d_T.r().C)([]));
  var $x_3 = $x_5.q([...$x_4], [...$j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy20)]);
  var $x_2 = $j_scala$002escalajs$002ejs$002e$002dArray$002dOps$002dCommon$0024.$m_sjs_js_ArrayOpsCommon$();
  var items$proxy21 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_java$002elang$002e$002dObject.$d_T.r().C)(["vec4<f32>"]));
  var $x_1 = $j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy21);
  var items$proxy22 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_java$002elang$002e$002dObject.$d_T.r().C)([]));
  var wgslCode = $j_gpu$002eshader$002e$002dShader$002dDef.$p_Lgpu_shader_ShaderDef__buildWGSL__T__T__T__T__T__T__T(triangleShader, $x_25, $x_15, $x_7, $j_gpu$002eshader$002ederive$0024.$p_Lgpu_shader_derive$__generateUniformGroupFromLists__I__sjs_js_Array__sjs_js_Array__T($x_6, 0, $x_3, $x_2.q([...$x_1], [...$j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy22)])), triangleShader.bj, triangleShader.bi);
  console.log(("Generated WGSL:\n" + wgslCode));
  var shaderModule = device.createShaderModule(({
    "code": wgslCode
  }));
  $j_gpu$002ebuffers$002e$002dAttrib$002dLayout$002dHelper$0024.$m_Lgpu_buffers_AttribLayoutHelper$().ft();
  ...
  var value$proxy1 = $j_gpu$002emath$002epackage$0024package$0024.$m_Lgpu_math_package$package$().z().w(other$proxy1.e0);
  _1.setFloat32(0, value$proxy1, true);
  var value$proxy2 = $j_gpu$002emath$002epackage$0024package$0024.$m_Lgpu_math_package$package$().z().w(other$proxy1.e1);
  _1.setFloat32(4, value$proxy2, true);
  var value$proxy3 = $j_gpu$002emath$002epackage$0024package$0024.$m_Lgpu_math_package$package$().d3().cq(1.0);
  _1.setFloat32(8, value$proxy3, true);
  var value$proxy4 = $j_gpu$002emath$002epackage$0024package$0024.$m_Lgpu_math_package$package$().d3().cq(0.0);
  _1.setFloat32(12, value$proxy4, true);
  var value$proxy5 = $j_gpu$002emath$002epackage$0024package$0024.$m_Lgpu_math_package$package$().d3().cq(0.0);
  _1.setFloat32(16, value$proxy5, true);
  var value$proxy6 = $j_gpu$002emath$002epackage$0024package$0024.$m_Lgpu_math_package$package$().d3().cq(1.0);
  _1.setFloat32(20, value$proxy6, true);
  var value$proxy7 = $j_gpu$002emath$002epackage$0024package$0024.$m_Lgpu_math_package$package$().z().w((-0.5));
  _1.setFloat32(24, value$proxy7, true);
  var value$proxy8 = $j_gpu$002emath$002epackage$0024package$0024.$m_Lgpu_math_package$package$().z().w((-0.5));
  _1.setFloat32(28, value$proxy8, true);
  var value$proxy9 = $j_gpu$002emath$002epackage$0024package$0024.$m_Lgpu_math_package$package$().z().w(0.0);
  _1.setFloat32(32, value$proxy9, true);
  var value$proxy10 = $j_gpu$002emath$002epackage$0024package$0024.$m_Lgpu_math_package$package$().z().w(1.0);
  _1.setFloat32(36, value$proxy10, true);
  var value$proxy11 = $j_gpu$002emath$002epackage$0024package$0024.$m_Lgpu_math_package$package$().z().w(0.0);
  _1.setFloat32(40, value$proxy11, true);
  var value$proxy12 = $j_gpu$002emath$002epackage$0024package$0024.$m_Lgpu_math_package$package$().z().w(1.0);
  _1.setFloat32(44, value$proxy12, true);
  var value$proxy13 = $j_gpu$002emath$002epackage$0024package$0024.$m_Lgpu_math_package$package$().z().w(0.5);
  _1.setFloat32(48, value$proxy13, true);
  var value$proxy14 = $j_gpu$002emath$002epackage$0024package$0024.$m_Lgpu_math_package$package$().z().w((-0.5));
  ...
  var items$proxy23 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().bu(new ($j_scala$002escalajs$002ejs$002e$002dObject.$d_sjs_js_Object.r().C)([entry]));
  var $x_37 = $j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy23);
  var items$proxy24 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_scala$002escalajs$002ejs$002e$002dDynamic.$d_sjs_js_Dynamic.r().C)([]));
  var items$proxy25 = $x_39.d(new ($j_scala$002escalajs$002ejs$002e$002dArray.$d_sjs_js_Array.r().C)([$x_38.q([...$x_37], [...$j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy24)])]));
  var $x_40 = $j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy25);
  var items$proxy26 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_scala$002escalajs$002ejs$002e$002dArray.$d_sjs_js_Array.r().C)([]));
  var descriptors = $x_41.q([...$x_40], [...$j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy26)]);
  var items$proxy27 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_webgpu$002e$002dG$002dP$002dU$002dBind$002dGroup$002dLayout.$d_Lwebgpu_GPUBindGroupLayout.r().C)([]));
  ...
  var \u03b42$___1 = result;
  var \u03b42$___2 = $j_gpu$002eshader$002elayouts$0024.$m_Lgpu_shader_layouts$().fd(device, result);
  ...
  var items$proxy28 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_java$002elang$002e$002dObject.$d_T.r().C)(["float32x2"]));
  ...
  var items$proxy29 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_java$002elang$002e$002dObject.$d_T.r().C)(["float32x4"]));
  var $x_42 = $j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy29);
  var items$proxy30 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_java$002elang$002e$002dObject.$d_T.r().C)([]));
  var formats = $x_45.q([...$x_44], $x_43.q([...$x_42], [...$j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy30)]));
  var $x_49 = $j_scala$002escalajs$002ejs$002e$002dArray$002dOps$002dCommon$0024.$m_sjs_js_ArrayOpsCommon$();
  var items$proxy31 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().bw(new $j_java$002elang$002e$002dObject.$ac_I(new Int32Array([8])));
  ...
  var items$proxy32 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().bw(new $j_java$002elang$002e$002dObject.$ac_I(new Int32Array([16])));
  var $x_46 = $j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy32);
  var items$proxy33 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().bw(new $j_java$002elang$002e$002dObject.$ac_I(new Int32Array([])));
  var sizes = $x_49.q([...$x_48], $x_47.q([...$x_46], [...$j_scala$002escalajs$002eruntime$002e$002dCompat$0024.$m_sjsr_Compat$().b(items$proxy33)]));
  ...
  var items$proxy34 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().d(new ($j_scala$002escalajs$002ejs$002e$002dDynamic.$d_sjs_js_Dynamic.r().C)([]));
  ...
  var items$proxy35 = $x_51.d(new ($j_scala$002escalajs$002ejs$002e$002dDynamic.$d_sjs_js_Dynamic.r().C)([({
  ...
  var items$proxy36 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().bu(new ($j_scala$002escalajs$002ejs$002e$002dObject.$d_sjs_js_Object.r().C)([({
    "format": "bgra8unorm"
  })]));
  ...
  var items$proxy37 = $x_52.bu(new ($j_scala$002escalajs$002ejs$002e$002dObject.$d_sjs_js_Object.r().C)([({
    "binding": 0,
    "resource": _2$8
  })]));
