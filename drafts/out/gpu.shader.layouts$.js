...
function $p_Lgpu_shader_layouts$__calculateOffsets__sjs_js_Array__sjs_js_Array($thiz, sizes) {
  var items$proxy1 = $j_java$002elang$002e$002dObject.$m_sr_ScalaRunTime$().ak(new $j_java$002elang$002e$002dObject.$ac_I(new Int32Array([])));
...
$p.dh = (function(device, bindGroupLayouts) {
