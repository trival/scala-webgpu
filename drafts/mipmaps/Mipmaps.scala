...
def main(): Unit =
  ...
  Painter.init(canvas): painter =>
    ...
    verts(0).set0(0.0, 0.8); verts(0).set1(1.0, 0.2, 0.1)
    verts(1).set0(-0.6, -0.3); verts(1).set1(1.0, 0.6, 0.0)
    verts(2).set0(0.6, -0.3); verts(2).set1(0.9, 0.3, 0.1)
    // Triangle 2 — green
    verts(3).set0(-0.8, 0.6); verts(3).set1(0.1, 0.9, 0.2)
    verts(4).set0(-0.9, -0.5); verts(4).set1(0.0, 0.7, 0.4)
    verts(5).set0(-0.1, -0.1); verts(5).set1(0.2, 1.0, 0.1)
    // Triangle 3 — blue
    verts(6).set0(0.8, 0.7); verts(6).set1(0.1, 0.3, 1.0)
    verts(7).set0(0.2, -0.2); verts(7).set1(0.2, 0.5, 0.9)
    verts(8).set0(0.9, -0.6); verts(8).set1(0.0, 0.2, 0.8)
    // Triangle 4 — yellow
    verts(9).set0(-0.3, 0.4); verts(9).set1(1.0, 1.0, 0.1)
    verts(10).set0(0.3, 0.4); verts(10).set1(0.9, 0.9, 0.3)
    verts(11).set0(0.0, -0.8); verts(11).set1(1.0, 0.8, 0.0)
    ...
    def makeQuad(x0: Double, y0: Double, x1: Double, y1: Double): Form =
      ...
      v(0).set0(x0, y0); v(0).set1(0.0, 1.0)
      v(1).set0(x1, y0); v(1).set1(1.0, 1.0)
      v(2).set0(x1, y1); v(2).set1(1.0, 0.0)
      v(3).set0(x0, y0); v(3).set1(0.0, 1.0)
      v(4).set0(x1, y1); v(4).set1(1.0, 0.0)
      v(5).set0(x0, y1); v(5).set1(0.0, 0.0)
