...
def main(): Unit =
  ...
  Painter.init(canvas): painter =>
    ...
    verts(0).set0(0.0, 0.8); verts(0).set1(1.0, 0.2, 0.1); verts(0).set2(0.3, 0.7, 0.6)
    verts(1).set0(-0.6, -0.3); verts(1).set1(0.9, 0.3, 0.1); verts(1).set2(0.3, 0.7, 0.6)
    verts(2).set0(0.6, -0.3); verts(2).set1(1.0, 0.5, 0.2); verts(2).set2(0.3, 0.7, 0.6)
    // Triangle 2 — green, facing left
    verts(3).set0(-0.8, 0.6); verts(3).set1(0.1, 0.9, 0.2); verts(3).set2(-0.8, 0.2, 0.5)
    verts(4).set0(-0.9, -0.5); verts(4).set1(0.0, 0.7, 0.4); verts(4).set2(-0.8, 0.2, 0.5)
    verts(5).set0(-0.1, -0.1); verts(5).set1(0.2, 1.0, 0.1); verts(5).set2(-0.8, 0.2, 0.5)
    // Triangle 3 — blue, facing camera
    verts(6).set0(0.8, 0.7); verts(6).set1(0.1, 0.3, 1.0); verts(6).set2(0.0, 0.0, 1.0)
    verts(7).set0(0.2, -0.2); verts(7).set1(0.2, 0.5, 0.9); verts(7).set2(0.0, 0.0, 1.0)
    verts(8).set0(0.9, -0.6); verts(8).set1(0.0, 0.2, 0.8); verts(8).set2(0.0, 0.0, 1.0)
    // Triangle 4 — yellow, facing down
    verts(9).set0(-0.3, 0.4); verts(9).set1(1.0, 1.0, 0.1); verts(9).set2(0.1, -0.9, 0.4)
    verts(10).set0(0.3, 0.4); verts(10).set1(0.9, 0.9, 0.3); verts(10).set2(0.1, -0.9, 0.4)
    verts(11).set0(0.0, -0.8); verts(11).set1(1.0, 0.8, 0.0); verts(11).set2(0.1, -0.9, 0.4)
